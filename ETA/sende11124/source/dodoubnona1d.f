c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine dodoubnona1d(idat2,ndoub,cvec,g,nroot,nhere,i2e,iacto,  6d13s22
     $                  ism,irelo,ipxder,wgt,bc,ibc)                    11d14s22
     ...
     $     i2e(1),iacto(8),ism(1),irelo(1),phs(2),ipxder(4,8,8,8),wgt(*)6d28s22
      data phs/1d0,-1d0/
      do i=1,ndoub
       ...
       jk=0                                                             6d16s22
       do k=1,nhere                                                     6d16s22
        do j=1,nroot                                                    6d16s22
         ww=wgt(j)*phs(iphdws)*cvec(jk+j,i2)*g(jk+j,i1)                 6d16s22
