c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine dosingnona1d(idat1,n1,cvec,g,nroot,nhere,iden1,        6d15s22
     $     iaorb,nalpha,jdenpt,iborb,nbeta,kadd,ism,irelo,iacto,        6d15s22
     $     ioffdetb,ipxder,wgt,l2e,bc,ibc,mdenoff)                      3d15s23
     ...
     $     iden1(1),jdenpt(1),ism(1),irelo(1),iacto(8),ipxder(4,8,8,8)  6d28s22
      dimension phs(2),wgt(*)                                           6d15s22
      data phs/1d0,-1d0/
      do i=1,n1
       ib=idat1(1,i)
       ik=idat1(2,i)
       ...
       iad=iden1(isbb)+ii1                                              6d15s22
       if(l2e)then                                                      6d16s22
        do k=1,nhere                                                     3d14s17
         ka=k+kadd                                                       3d14s17
         do j=1,nroot                                                    3d14s17
          vv=g(j,k,ib)*cvec(j,k,ik)*wgt(j)*phs(idat1(4,i))
          bc(iad)=bc(iad)+vv                                             6d15s22
         end do                                                          3d14s17
        end do
        ...
        do j=1,nalpha                                                    9d1s06
         ...
         iadc=jdenpt(i2eu)+ix12+ipxder(4,isbb,isbk,isx)*ix21            6d28s22
         ...
         iade=jdenpt(i2eu)+ix12+ipxder(4,isbb,isx,isx)*ix21             6d28s22
         do k=1,nhere                                                     3d14s17
          ka=k+kadd                                                       3d14s17
          do jj=1,nroot                                                    3d14s17
           vv=g(jj,k,ib)*cvec(jj,k,ik)*wgt(jj)*phs(idat1(4,i))
           bc(iadc)=bc(iadc)+vv                                         6d16s22
           bc(iade)=bc(iade)-vv                                         6d16s22
          end do                                                          3d14s17
         end do
        end do                                                           9d1s06
        do k=1,nhere                                                     3d14s17
        ...
        nad=iacto(isbb)*iacto(isbk)                                     3d15s23
        iad=iad+nad*mdenoff                                             3d15s23
        do j1=1,nroot                                                   3d15s23
         do j2=1,j1                                                     3d15s23
          do k=1,nhere                                                  3d15s23
           bc(iad)=bc(iad)+g(j1,k,ib)*cvec(j2,k,ik)*phs(idat1(4,i))     3d27s23
          end do                                                        3d15s23
          iad=iad+nad                                                   3d15s23
         end do                                                         3d15s23
        end do                                                          3d15s23
