...
C***FIRST EXECUTABLE STATEMENT  DSORT
      ...
      NN = N
      IF (NN .LT. 1) THEN
       write(6,*)('The number of values to be sorted is not positive.'),
     $      n
       stop 'dsortdws'
      ENDIF
C
