c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine tofrob(veco,vecnono,nroot,nfdat,nvirt,nsymb,multh,      12d21s20
     $     isymmrci,iflag,ndoub,mdoub,ff22,bc,ibc)                      11d10s22
...
c
      ...
      dimension veco(*),vecnono(*),nfdat(5,4,*),nvirt(*),multh(8,8),    8d3s21
     $     ff22(*)                                                      8d3s21
     ...
     $     mynnode                                                      5d24s18
      if(iflag.eq.10)then
       write(6,*)('hi, my name is tofrob ...')
       write(6,*)('nroot,nsymb,isymmrci,ndoub,mdoub: '),nroot,nsymb,
     $      isymmrci,ndoub,mdoub
       do isb=1,nsymb
        write(6,*)('for symmetry block '),isb
        write(6,*)('nvirt '),nvirt(isb)
        do l=1,4
         write(6,*)('for l = '),l
         write(6,*)('nfdat: '),(nfdat(j,l,isb),j=1,5)
        end do
       end do
       return
      end if
       ...
       do isbv1=1,nsymb                                                 12d21s20
        ...
        if(isbv2.ge.isbv1)then                                          12d31s20
         if(isbv1.eq.isbv2)then                                         12d21s20
          ...
          if(min(nfdat(3,1,isb),nhere).gt.0)then                        11d17s21
     ...
     $       vecnono(istartn),nnv,ff22(nfdat(4,1,isb)),nfdat(2,1,isb),  8d3s21
     $           0d0,veco(istarto),nnv,                                 8d3s21
     d' tofrob.  2')
           end if                                                       12d21s20
          end if                                                        12d21s20
     ...
     $       vecnono(istartn),nvv,ff22(nfdat(4,l,isb)),nfdat(2,l,isb),
     $            0d0,veco(istarto),nvv,                                8d3s21
     d' tofrob.  4')
            end if                                                       12d21s20
           end if                                                       12d21s20
           ioffo=ioffo+nvv*nfdat(3,l,isb)                                12d21s20
           ioffnono=ioffnono+nvv*nfdat(2,l,isb)                          12d21s20
          end if                                                        12d21s20
         end do                                                         12d21s20
        end if                                                          12d21s20
       end do                                                           12d21s20
