c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine wrot2(iddiag,nff2,ncsf,ncsf2,mdon,mdoop,isymmrci,      2d13s22
     $     nvirt,nsymb,multh,ovr,nroot,vecno,bc,ibc)                    11d9s22
       ...
       do isb=1,nsymb                                                   8d19s21
        ...
        if(min(nff2(ii,isb),nvisv+nvnotv).gt.0)then                     8d20s21
         ...
         if(nhere.gt.0)then                                             8d21s21
          ...
          call enough('wrot2.  2',bc,ibc)
          nother=(nrow/nroot)*nhere                                     2d13s22
