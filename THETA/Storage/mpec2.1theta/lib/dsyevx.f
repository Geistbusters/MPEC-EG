...
c$$$      write(6,*)('before dorgtr ')
c$$$      if(eps.ne.132d0)stop
            CALL DORGTR( UPLO, N, Z, LDZ, WORK( INDTAU ),
     $                   WORK( INDWRK ), LLWORK, IINFO )
c$$$      write(6,*)('after dorgtr ')
c$$$      if(eps.ne.132d0)stop
            CALL DCOPY( N-1, WORK( INDE ), 1, WORK( INDEE ), 1 )
c$$$      write(6,*)('before dsteqr ')
c$$$      if(eps.ne.132d0)stop
            CALL DSTEQR( JOBZ, N, W, WORK( INDEE ), Z, LDZ,
     $                   WORK( INDWRK ), INFO )
c$$$      write(6,*)('after dsteqr ')
c$$$      if(eps.ne.132d0)stop
            IF( INFO.EQ.0 ) THEN
c$$$      write(6,*)('before do 30 ')
c$$$      if(eps.ne.132d0)stop
               DO 30 I = 1, N
                  IFAIL( I ) = 0
   30          CONTINUE
c$$$      write(6,*)('after do 30 ')
c$$$      if(eps.ne.132d0)stop
            END IF
         END IF
         IF( INFO.EQ.0 ) THEN
...
*
            ...
            END IF
   60    CONTINUE
c$$$      write(6,*)('after do 60 ')
c$$$      if(eps.ne.132d0)stop
      END IF
*
*     Set WORK(1) to optimal workspace size.
*
c$$$      write(6,*)('before set work(1) ')
c$$$      if(eps.ne.132d0)stop
      WORK( 1 ) = MAX( 7*N, LOPT )
c$$$      write(6,*)('after set work(1) ')
c$$$      if(eps.ne.132d0)stop
*
      RETURN
*
