c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $     mddilow,mddihig,itargs,itargd,iqhrc)                         12d9s24
     ...
     $     mynnode
      ...
      if(mynowprog.eq.0)then                                            2d3s22
       write(6,*)('in getwf for file '),fname,kcall
      end if                                                            2d3s22
     ...
     $     (bc(iextrad+i),i=0,nextradatatag-1)                          5d27s21
       ...
       do isb=1,nsymb
        ...
        write(6,*)('for isb '),isb,need,jout,ncomp,iorb(isb),icall
       ...
       write(6,*)('nec '),nec,jff0,mdon,mdoop,nct
       ...
       write(6,*)('iunc, ethred, nctf,ntot '),iunc,ethred,nctf,ntot
       ...
       read(1,err=1515)(bc(ieig+i),i=0,nroot*2-1)                       3d17s25
       go to 1516                                                       3d17s25
 1515  continue                                                         3d17s25
       write(6,*)('hit error on reading eig ...')                       3d17s25
       write(6,*)('try reading in only 1 set of roots')                 3d17s25
       backspace(1)                                                     3d17s25
       read(1)(bc(ieig+i),i=0,nroot-1)                                  3d17s25
       write(6,*)('ok, so pad out roots ')                              3d17s25
       do i=0,nroot-1                                                   3d17s25
        ip=i+nroot                                                      3d17s25
        bc(ieig+ip)=bc(ieig+i)                                          3d17s25
       end do                                                           3d17s25
       write(6,*)('ok ')                                                3d17s25
 1516  continue                                                         3d17s25
       if(mynowprog.eq.0)then                                           2d15s22
        if(nroot.eq.1)then                                              7d11s23
         ...
         write(6,*)('2nd set of eigenvalues: '),(bc(ieig+i+nroot),i=0,  12d9s24
     $        nroot-1)                                                  12d9s24
        end if                                                          7d11s23
       end if                                                           2d15s22
       if(iqhrc.ne.0)then                                               12d9s24
        write(6,*)('replace energies with +q(h,RD) energies ')          12d9s24
        do i=0,nroot-1                                                  12d9s24
         bc(ieig+i)=bc(ieig+nroot+i)                                    12d9s24
        end do                                                          12d9s24
        write(6,*)('eigenvalues '),(bc(ieig+i),i=0,nroot-1)             12d9s24
       end if                                                           12d9s24
     ...
     $        iwavedat(2,1).eq.7.or.iwavedat(2,1).eq.8)iord=1           3d28s22
       ...
       read(1)mff1                                                      7d8s21
       write(6,*)('mff1 read in = '),mff1
       if(mff1.eq.0)then                                                12d21s22
        jtargs=0                                                        12d21s22
       else                                                             12d21s22
        jtargs=1                                                        12d21s22
       end if                                                           12d21s22
       write(6,*)('jtargs,itargs '),jtargs,itargs
     ...
     $       ibc(icsf),1)                                               8d18s22
       ...
       write(6,*)('jtargd,itargd '),jtargd,itargd
