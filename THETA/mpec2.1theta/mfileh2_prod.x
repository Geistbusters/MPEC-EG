...
##if $BUILDTYPE=="prod"
#then
cat <<@ > ~/.prempec_theta_rome
eval \`/usr/bin/modulecmd bash load  comp-intel/2023.2.1 mpi-hpe/mpt.2.30\`  
#comp-intel/2020.4.304 mpi-hpe/mpt\`
PATH=\$PATH:/u/scicon/tools/bin
alias runmpec='mpiexec mbind.x $root/exe/prod/mpec_theta_rome'
@
chmod og+rx ~/.prempec_theta_rome
. ~/.prempec_theta_rome
### ddi1
#ddi=1
### ddi4
...
abtrans3.o tt4v.o paraeridd.o der4v.o postden.o gaoovr.o catorbs.o lsqnormal.o bodc1fd.o bodcfdb.o parap2.o prebodcfd.o step.o vandr2.o psipsiden.o hccsfbkden.o \
denmx12bodc.o
...
abtrans3.o tt4v.o paraeridd.o der4v.o postden.o gaoovr.o catorbs.o lsqnormal.o bodc1fd.o bodcfdb.o parap2.o prebodcfd.o step.o vandr2.o psipsiden.o \
hccsfbkden.o denmx12bodc.o $f3 
start.o : $s/start.f $s/common.store ; $f2 -c $opt $s/start.f
step.o : $s/step.f ; $f2 -c $opt $s/step.f
vandr2.o : $s/vandr2.f ; $f2 -c $opt $s/vandr2.f
prebodcfd.o : $s/prebodcfd.f $s/common.store ; $f2 -c $opt $s/prebodcfd.f
parap2.o : $s/parap2.f $s/common.hf $s/common.store $s/common.spher $s/common.basis ; $f2 -c $opt $s/parap2.f
bodc1fd.o : $s/bodc1fd.f $s/common.store ; $f2 -c $opt $s/bodc1fd.f
bodcfdb.o : $s/bodcfdb.f $s/common.store ; $f2 -c $opt $s/bodcfdb.f
catorbs.o : $s/catorbs.f $s/common.store ; $f2 -c $opt $s/catorbs.f
...
gaoovr.o : $s/gaoovr.f $s/common.store ; $f2 -c $opt $s/gaoovr.f
...
lsqfit2.o : $s/lsqfit2.f $s/common.store ; $f2 -c $opt $s/lsqfit2.f
lsqnormal.o : $s/lsqnormal.f  $s/common.store ; $f2 -c $opt $s/lsqnormal.f
...
psipsiden.o : $s/psipsiden.f $s/common.store ; $f2 -c $opt $s/psipsiden.f
...
hccsfbkden.o : $s/hccsfbkden.f $s/common.store $s/common.print ; $f2 -c $opt $s/hccsfbkden.f
...
denmx12bodc.o : $s/denmx12bodc.f $s/common.hf $s/common.store ; $f2 -c $opt $s/denmx12bodc.f
...
chmod og+rx mpec
mv mpec $root/exe/prod/mpec_theta_rome
