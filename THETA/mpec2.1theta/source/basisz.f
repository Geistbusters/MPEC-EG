...
c     30
      ...
      nprtr=nprtr+1                                                     3d29s24
      prtrname(nprtr)(1:12)='move2min    '                              12d17s24
c     35
      nprtr=nprtr+1                                                     3d29s24
      prtrname(nprtr)(1:12)='cat         '                              1d23s25
      epsym=1d-8                                                        2d3s12
      pi=acos(-1d0)
 ...
 5577 continue                                                          11d4s05
  ...
  254 continue                                                          8d8s14
      ...
      if(line(is:is+3).eq.'&CAT')go to 5253                             1d21s25
...
c
  110 continue                                                          8d8s14
    ...
    1 continue
       ...
       if(line(is:is+4).eq.'bisec')then                                 2d14s25
        write(6,*)('theta1 will bisect axis')                           2d14s25
        if(line(ie:ie).eq.'z')then                                      2d21s25
         write(6,*)('bisect z axis')                                    2d21s25
         ibisect=1                                                       2d14s25
        else                                                            2d21s25
         write(6,*)('bisect x axis')                                    2d21s25
         ibisect=2                                                      2d21s25
        end if                                                          2d21s25
        go to 1                                                         2d14s25
       end if                                                           2d14s25
...
c
     ...
     $      bc(iextradatad),ibisect)                                    2d14s25
...
c
 ...
 1067  continue                                                         2d18s10
     ...
     $        then                                                      10d27s20
         ...
         itryg8=ibc(jbdat+ngaus8)                                       3d1s25
         ming8=min(ming8,itryg8)                                        3d1s25
        ...
        if(ming8.eq.-1)then                                             3d1s25
         ibc(jbdat0+ngaus8)=-1                                          3d1s25
        end if                                                          3d1s25
        if((ncont.gt.1.or.(inoc(l+1).eq.0.and.idorel.ne.0)).            10d27s20
     $       and.icdatu.ne.icdatsave.and.                               4d24s25
     $       (ming8.lt.-1.or.itryg8.gt.0))then                          4d24s25
         if(idorel.eq.0)then                                             9d12s17
          nzetau=nzeta                                                   9d12s17
         else                                                            9d12s17
...
c                                                                       2d14s19
      ...
      do i=1,ngaus
       ...
       if(nccode.gt.0.or.nccode.eq.-1)then                              3d1s25
...
c                                                                       2d19s04
 1252 continue
     ...
     $      idum,idum,idum,1,bc,ibc,icanon)                             12d5s24
...
c
  251 continue                                                          11d4s05
     ...
     $      nlorcont,idum,idum,idum,1,bc,ibc,icanon)                    12d5s24
       ngrp=nsymb                                                       2d24s21
...
c
 ...
 6605   continue                                                        1d3s20
       ...
       if(line(is:is+8).eq.'usenormal')then                             1d28s25
        is=ie+1                                                         1d28s25
        call delim(line,is,ie)                                          1d28s25
        if(ie.gt.is)then                                                1d28s25
         if(line(is:is+1).eq.'no'.or.line(is:is+2).eq.'off'.or.         1d28s25
     $       line(is:is+2).eq.'svd')then                                1d28s25
          iusenormal=0                                                  1d28s25
          write(6,*)('gradient DIIS extrapolations will use SVD'),      1d28s25
     $         (' rather than normal equations')                        1d28s25
         else if(line(is:is+3).eq.'test')then                           1d28s25
          write(6,*)('gradient DIIS extrapolations will test normal'),  1d28s25
     $         (' equations by also computing SVD solution')            1d28s25
          iusenormal=2                                                  1d28s25
         end if                                                         1d28s25
        end if                                                          1d28s25
       end if                                                           1d28s25
...
c
     ...
     $        dynw(1),(' Eh')                                           7d27s23
         ...
         if(dynw(1).lt.0d0)then                                         11d29s24
          write(6,*)('first dynamic weight parameter is negative!!!')   11d29s24
          write(6,*)('it needs to be positive!')                        12d2s24
          write(6,*)('did you reverse the input order? ')               11d29s24
          irtrn=1                                                       11d29s24
          return                                                        11d29s24
         end if
         is=ie+1                                                        12d31s19
...
c
             ncha=ie+1-is                                               8d8s22
             if(ncha.le.3)then                                          3d5s25
              if(line(is+1:is+1).eq.'A'.and.nsymb.eq.1)then             3d5s25
               go to 1492                                               3d5s25
              end if                                                    3d5s25
     ...
     $              line(is+2:is+2).ne.'i'))then                        5d2s24
              ...
              write(6,*)('first atomic asymptote: '),line(is:ie)        3d5s25
...
c     ie=is means atomic term
c     is+1:is+1=o also means atomic term
c     except when ie=is and line(is:is)='A' and nsymb=1
            if((ie.eq.is.and.line(is:is).ne.'A').or.                    3d12s25
     $           line(is+1:is+1).eq.'o')then                            3d12s25
             nlzz=6                                                     12d31s19
     ...
     $            line(ie:ie).ne.'u'))then                              3d3s21
            ...
            else if(line(is:is).eq.'A'.and.nsymb.eq.1)then              3d5s25
             issym=1                                                    3d5s25
             isp=is+1                                                   3d5s25
     ...
     $             line(is+1:is+1).eq.'2')then                          12d24s19
              ...
              write(6,*)('bad term symbolb: '),line(is:ie)
...
c
 ...
 1809   continue                                                        8d3s21
        call delim(line200,is,ie)                                       1d28s25
 6602   continue                                                        5d10s19
  200   format(a200)                                                    1d28s25
 ...
 2027      format(6i5)
     ...
     $        +irxinfos(2,jj)                                           12d29s21
        ...
        if(line200(is:is+8).eq.'usenormal')then                         1d28s25
         is=ie+1                                                        1d28s25
         call delim(line200,is,ie)                                      1d28s25
         if(ie.gt.is)then                                               1d28s25
          if(line200(is:is+1).eq.'no'.or.line200(is:is+2).eq.'off'.or.  1d28s25
     $       line200(is:is+2).eq.'svd'.or.line200(is:is+2).eq.'SVD')then1d28s25
           iusenormalci=0                                               1d28s25
           write(6,*)('gradient DIIS extrapolations will use SVD'),     1d28s25
     $         (' rather than normal equations')                        1d28s25
          else if(line200(is:is+3).eq.'test')then                       1d28s25
           write(6,*)('gradient DIIS extrapolations will test normal'), 1d28s25
     $         (' equations by also computing SVD solution')            1d28s25
           iusenormalci=2                                               1d28s25
          end if                                                         1d28s25
          is=ie+1                                                       1d28s25
         end if                                                          1d28s25
        end if                                                           1d28s25
...
c                                                                       5d24s18
 ...
 1037       continue                                                    12d24s19
     ...
     $              stype(isb,ngrp),('"')
              ...
              write(6,*)('bad term symbola: '),line200(is:ie)            12d24s19
              write(6,*)('we were searching from the list ')            1d14s20
              do isb=1,ngrp                                             1d14s20
               write(6,*)stype(isb,ngrp)                                1d14s20
              end do                                                    1d14s20
...
c                                                                       11d21s19
 ...
 6604   continue                                                        1d3s20
        ...
        if(line200(is:is+2).eq.'q(h')then                               12d9s24
         iqhrc=1                                                        12d9s24
         write(6,*)('in property code, use q(h,RD) energies ')          12d9s24
         go to 2225                                                     11d16s23
        end if                                                          12d9s24
        ...
        if(line200(is:is+3).eq.'BODC'.or.line200(is:is+3).eq.'bodc')then2d13s25
         write(6,*)                                                     9d17s24
     ...
     $        (' matrix elements')                                      2d8s23
        ...
        if(nfname.eq.0.and.numeminus.eq.0)then                          11d22s19
         ...
         call loadr(potdws,ibdat,ibstor,isstor,nsymb,istinfo,ncoreg,    1d2s20
     $        nvalg,nlzzq,iextradatd,nectradatx,0,nbasdws,element,idum, 7d26s22
     $        nec,mdon,mdoop,2,bc,ibc,icanon)                           12d5s24
         nfned=1                                                        12d5s22
...
c     include lambda in nlzzq.                                          10d7s24
 ...
 2226   continue                                                        11d22s19
     ...
     $         nec,mdon,mdoop,2,bc,ibc,icanon)                          12d5s24
        ...
        return                                                          1d14s20
 5253   continue                                                        1d21s25
c                                                                       1d21s25
c     concatenate two or more orbital files.                            1d21s25
c                                                                       1d21s25
        write(6,*)('concatenation input ')                              1d21s25
        nfname=0                                                        1d21s25
 5353   continue
         read(5,200,end=5354)line200                                    1d21s25
         is=1                                                            11d22s19
         call delim(line200,is,ie)                                       11d22s19
         if(line200(is:is).eq.'#')go to 5353                            1d21s25
         write(6,*)('testing on "'),line200(is:is+4),('"')              1d24s25
         if(line200(is:is+4).eq.'debug')then                            1d24s25
 6666     continue                                                        6d5s20
          is=ie+1                                                        6d5s20
          call delim(line200,is,ie)                                     1d24s25
          if(ie.ge.is)then                                               6d5s20
           write(6,*)('debug print out turned on for '),line200(is:ie)  1d24s25
           nchere=ie+1-is                                                6d5s20
           do i=1,nprtr                                                  6d5s20
            if(line200(is:ie).eq.prtrname(i)(1:nchere))then             1d24s25
             iprtr(i)=1                                                  6d5s20
             go to 6666                                                  6d5s20
            end if                                                       6d5s20
           end do                                                        6d5s20
         ...
         nfname=nfname+1                                                1d21s25
         iunit=6+nfname                                                 1d21s25
         write(6,*)('opening orbital file '),line200(is:ie)             1d21s25
         open(unit=iunit,file=line200(is:ie),form='unformatted',        1d21s25
     $        status='old')                                             1d21s25
         go to 5353                                                     1d21s25
 5354   continue                                                        1d21s25
        write(6,*)('all in ')                                           1d21s25
        open(unit=4,file='forbs',form='unformatted')                    1d21s25
        insymb=ibcoff                                                   1d22s25
        ingaus=insymb+nfname                                            1d22s25
        inatom=ingaus+nfname                                            1d22s25
        inwcont=inatom+nfname                                           1d22s25
        inbasdws=inwcont+nfname                                         1d22s25
        inlorcont=inbasdws+nfname*8                                     1d22s25
        inbasisc=inlorcont+nfname*8                                     1d22s25
        inbasisp=inbasisc+nfname*8                                      1d22s25
        iisym=inbasisp+nfname*8                                         1d22s25
        iidoub=iisym+nfname*24                                          1d22s25
        iiacto=iidoub+nfname*8                                          1d22s25
        iiapair=iiacto+nfname*8                                         1d22s25
        iibdat=iiapair+3*ida                                            1d22s25
        iibstor=iibdat+nfname                                           1d22s25
        iisstor=iibstor+nfname                                          1d22s25
        iibcode=iisstor+nfname                                           1d22s25
        iiorbov=iibcode+nfname*8                                         1d22s25
        iiorbao=iiorbov+nfname*8                                          1d22s25
        iball=iiorbao+nfname*8                                          1d22s25
        ibcoff=iball+nfname                                             1d22s25
        call enough('basisz.catorbs',bc,ibc)                            1d22s25
        write(6,*)('loc bc '),loc(bc)
        call catorbs(nfname,bc(insymb),bc(ingaus),bc(inatom),           1d22s25
     $       bc(inwcont),bc(inbasdws),bc(inlorcont),bc(inbasisc),       1d22s25
     $       bc(inbasisp),bc(iisym),bc(iidoub),bc(iiacto),bc(iiapair),  1d22s25
     $       bc(iibdat),bc(iibstor),bc(iisstor),bc(iibcode),bc(iiorbov),1d22s25
     $       bc(iiorbao),bc(iball),bc,ibc)                              1d22s25
        ibcoff=insymb                                                   1d22s25
        irtrn=2                                                         1d22s25
        return                                                          1d21s25
c                                                                       1d10s19
...
c                                                                       1d10s19
 2253   continue                                                        1d10s19
        ...
        iforce=0                                                        7d17s23
        ifdiff=0                                                        6d24s24
        ibdatpt=ibcoff                                                  12d5s24
        ibcoff=ibdatpt+iddx                                             12d5s24
        call enough('ibdatpt',bc,ibc)                                   12d5s24
 2254   continue
 ...
 2256   continue                                                        1d3s20
     ...
     $       idum,idum,idum,1,bc,ibc,icanon)                            12d5s24
        jbdatpt=ibdatpt+nfname-1                                        12d5s24
        ibc(jbdatpt)=ibdat                                              12d5s24
...
c
     ...
     $            ibc(ibcode(isb,1)+i),ibc(ibcode(isb,if)+i)            6d24s24
           ...
           if(iprtr(31).ne.0)then                                       12d4s24
            write(6,*)('raw orbitals: ')                                12d4s24
            write(6,*)('ao basis ')                                     12d5s24
            call prntm2(bc(iorbao(isb,1)),nbasbb,nbasdws(isb),nbasbb)   12d5s24
            write(6,*)('orthogonal basis ')
            call prntm2(bc(iorb(isb,1)),nnxh,nbasdws(isb),nnxh)         12d4s24
            do if=2,nfname                                              12d4s24
             write(6,*)('reference orbital set '),if-1                  12d4s24
             write(6,*)('ao basis ')                                    12d5s24
             call prntm2(bc(iorbao(isb,if)),nbasbb,nbasdws(isb),nbasbb) 12d5s24
             write(6,*)('orthogonal basis ')                            12d5s24
             call prntm2(bc(iorb(isb,if)),nnxh,nbasdws(isb),nnxh)       12d4s24
            end do                                                      12d4s24
           end if                                                       12d4s24
 ...
 2257      continue                                                       2d8s20
     ...
     $             +(c2*bc(i12)+s2*bc(i22))**2                          2d8s20
             ...
             if(sz/szo.gt.0.9999999999999d0)go to 2258                  ECG061825
             szo=sz                                                       2d9s20
            end do                                                        2d8s20
 2258       continue                                                      2d9s20
           else                                                         12d6s24
            write(6,*)('computing ouse for is = '),is                   12d6s24
            iouse=ibcoff                                                12d6s24
            ibcoff=iouse+1                                              12d6s24
            call enough('basisz.17a',bc,ibc)                            12d6s24
            iorb1=iorbt+is                                               2d9s20
            iorb2=iorb(isb,2)+nnxh*is                                   5d5s23
            call dgemm('n','n',1,1,nnxh,1d0,bc(iorb1),                  12d6s24
     $          nbasdws(isb),bc(iorb2),nnxh,0d0,bc(iouse),1,            12d6s24
     d' basisz.  1b')                                                   12d6s24
            write(6,*)('iouse for phasing: '),bc(iouse)                 12d6s24
           end if                                                       12d2s24
           det=1d0                                                       2d9s20
     ...
     $            ('different geometries?')                             3d15s24
         ...
         if(iprtr(31).ne.0)then                                         12d4s24
          write(6,*)('final orbitals in ao basis ')                     12d4s24
          call prntm2(bc(iorbao(isb,1)),nbasbb,nbasdws(isb),nbasbb)     12d4s24
          write(6,*)('in orthogonal basis ')                            12d4s24
          call prntm2(bc(iorb(isb,1)),nnxh,nbasdws(isb),nnxh)           12d4s24
         end if                                                         12d4s24
        end do                                                          2d8s20
        if(iprtr(31).ne.0)then                                          12d5s24
         write(6,*)('going for actual overlap of ao vectors ')          12d5s24
         write(6,*)('going after "'),pwd//'ghtab.ufort',('"')           12d5s24
         open(unit=1,file=pwd//'ghtab.ufort',form='unformatted')        12d5s24
         ...
         close(unit=1)                                                  12d5s24
         write(6,*)('generate lmax ')                                   12d5s24
         lmax=0                                                         12d5s24
         do i=1,ngaus                                                   12d5s24
          iaddr=ibc(ibdatpt)                                            12d5s24
          lhere=ibc(iaddr+i-1)                                          12d5s24
          lmax=max(lmax,lhere)                                          12d5s24
         end do                                                         12d5s24
         if(ncomp.ne.1)lmax=lmax+1                                      12d5s24
         write(6,*)('lmax going into spher '),lmax                      12d5s24
         call spher(lmax,bc,ibc)                                        12d5s24
         do if=2,nfname                                                 12d5s24
          jbdatpt=ibdatpt+if-1                                          12d5s24
          call gaoovr(ibc(ibdatpt),ibc(jbdatpt),iorbao,iorbao(1,if),    12d5s24
     $         ibc(ibstor),ibc(isstor),nsymb,nbasdws,nbasb,ncomp,ngaus, 12d5s24
     $         isym,iapair,ascale,bc,ibc)                               12d5s24
         end do                                                         12d5s24
        end if
