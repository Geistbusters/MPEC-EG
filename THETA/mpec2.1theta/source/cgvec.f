c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $     lprnt,iusenormal,bc,ibc)                                     1d28s25
...
c
 ...
 1000  continue                                                         4d13s23
     ...
     $       e,nwds)                                                    4d13s23
        ...
        do irt=0,nrootm                                                   4d12s23
         ...
         if(iusenormal.gt.0)then                                        1d28s25
          call lsqnormal(bc(ifmat),nps,nfit,rhs(1,irp),nps,1,nps,       1d28s25
     $      bc(icoef),nfit,iret,aratio,bc,ibc)                          1d28s25
          if(iret.ne.0)then                                             1d28s25
           write(6,*)('normal equations failed in cgvec ')              1d28s25
          ...
          if(iusenormal.eq.2.and.mynowprog.eq.0)then                    1d28s25
           ...
           call enough('cgvec.coefsvd',bc,ibc)                          1d28s25
     ...
     $      bc(icoefsvd),nfit,bc(iscr),bc(iwgt),0,rms,bc,ibc)           1d28s25
           ...
           write(6,*)('cgvec lsqnormal normal vs. svd: '),rmssvd         1d28s25
           if(rmssvd.gt.1d-10)                                          1d28s25
     $          write(6,*)('bad normal equations in cgvec!!!'),aratio   1d28s25
