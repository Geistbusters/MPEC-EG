...
c
      ...
      nbct=0                                                            4d25s18
      if(ldeb)write(6,*)('for primitives ')
     ...
     $       nbasiscu(isb)                                              3d3s20
      ...
      if(ldeb)write(6,*)('for contracted ')
      do j=1,nbct                                                       4d25s18
       jm=icoff+j                                                       4d24s18
...
c     ibstor(+icoff, isstor refer to contracted fcns ...
    ...
    2       format('fcn ',4i5,' is at ',i5,' in symmetry block ',i1,3i5)  4s23s18
           ...
           if(iflag.le.0)then                                           4d27s21
            if(ldeb)write(6,*)('contract '),ipass,nlzz,iflag                               4d30s18
     ...
     d' contractg.  1')
            ...
            if(ldeb)then
             ...
             write(6,*)('koff = '),koff
             write(6,*)('iseq,nseq,j,nl,nleft '),iseq,nseq,j,nl,nleft
            end if                                                       4d30s18
