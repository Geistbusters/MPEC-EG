...
c
     ...
     $     mynnode                                                      5d24s18
      ...
      data loopx/200/
      integer*8 i,i3xd,i4xd,iamatu,ibc000,ibcb4,ibcoffo,ibcxp,ibufs,icol
     $id1x,id3x,id4o,idaprt,iden,ie4v,ifder,iffp,ifmat,igd,ih0d
     $ihdd,ihds,imsg,iorbf,iovrdd,iovrdk,ipredorth,isnd,itmp,itmph
     $itmpt,itmpx,itnew,itt,itt4v,itthalf,iuu,ivtmp,j4o,jmatd
     $jmden,jonex,kmatd,kmden,nfdatd
     ...
     $       (' dot1e so far '),dot1e                                   7d11s23
       ...
       do is=1,nsdlk                                                     7d10s23
        ...
        if(min(nrow,ncol).gt.0)then                                      7d10s23
         if(ldebug)then                                                 3d28s25
          write(6,*)('d4o for sym '),(isblk(j,is),j=1,4)                3d28s25
          call prntm2(bc(id4o(is)),nrow,ncol,nrow)                      3d28s25
         end if                                                         3d28s25
         trace=0d0                                                        7d10s23
