c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $     bc,ibc,nstate,isinfo,nveccnt,icanon,iusenormal)              1d28s25
c
c     to dos:
...
c
     ...
     $     ivel(8,3),ivelp(3),npt(3),nveccnt(*),icanon(*)               5d5s23
      ...
      integer*8 iamatu,ibc0,ibcb4,ibctop,ibodc,ibodc3,icdc,icdir
     $icoefsvd
     $idarot,iden1d,iden1i,iden1o,ides,idiis1,idvec,iffmt,ifmat
     $ih0d,ih0da,imsg,ioder,iovrdd,iovrdk,itmp,ivel,ivelvsm
     $j2denbl,jdend
...
c
  ...
  537        format('<',2i2,a6,a2,'|',a4,'|',2i2,a6,a2,'> = ',          4d11s23
     ...
     $       j=1,4)
      ...
      ibcoff=imsg+mynnode                                               ECG_052925
      idenergy=1                                                        7d28s22
 ...
 1122     continue                                                      11d1s24
  ...
  122     continue                                                       8d30s22
           ...
           if(iterov.ge.2)then                                           5d17s22
            ...
            if(nden.gt.0)then                                           1d19s23
             if(iterov.gt.nprescf)then                                  11d1s24
              if(iusenormal.ne.0)then                                   1d28s25
               call lsqnormal(bc(iffmt),nden,iterm,bc(idata),nden,1,    1d28s25
     $         nden,bc(icoef),iterov,iret,aratio,bc,ibc)                1d28s25
               if(iret.ne.0)then                                        1d28s25
                idiirest=idiirest+1                                         1d27s25
                if(idiirest.lt.5)then                                       1d27s25
                 jdiis3=idiis3+(iterov-1)*nden                              1d27s25
                 do i=0,nden-1                                              10d31s24
                  bc(iden1d(1,1)+i)=bc(jdiis3+i)                            10d31s24
                 end do                                                     10d31s24
                 go to 1122                                                 1d27s25
                end if                                                  1d28s25
                call dws_synca                                          1d28s25
                call dws_finalize                                       1d28s25
                stop 'gradcasa'                                         1d28s25
               end if                                                   1d28s25
               if(iusenormal.eq.2)then                                  1d28s25
                icoefsvd=ibcoff                                         1d28s25
                ibcoff=icoefsvd+nden                                    1d28s25
                call enough('gradcas.coefsvda',bc,ibc)                  1d28s25
                call lsqfit2(bc(iffmt),nden,iterm,bc(idata),nden,1,     1d28s25
     $             nden,bc(icoefsvd),iterov,bc(iscr),bc(iwgt),0,rmsdiis,1d28s25
     $               bc,ibc)                                            1d28s25
                if(mynowprog.eq.0)then                                  1d28s25
                 rmssvd=0d0                                              1d28s25
                 do i=0,iterm-1                                          1d28s25
                  rmssvd=rmssvd+(bc(icoef+i)-bc(icoefsvd+i))**2          1d28s25
                 end do                                                  1d28s25
                 rmssvd=sqrt(rmssvd/dfloat(iterm))                       1d28s25
                 write(6,*)('gradcasa lsqnormal normal vs. svd: '),     1d28s25
     $                rmssvd                                            1d28s25
                 if(rmssvd.gt.1d-10)                                     1d28s25
     $                write(6,*)('bad normal equations in gradcasa')     1d28s25
                end if                                                  1d28s25
                ibcoff=icoefsvd                                         1d28s25
               end if                                                   1d28s25
              else                                                      1d28s25
     ...
     $          ('with last diff '),diff                                11d1s24
           ...
           if(nprescf.eq.0.and.iterov+2.gt.maxdiis)then                 1d27s25
            idiirest=idiirest+1                                         1d27s25
            if(idiirest.lt.5)then                                       1d27s25
             jdiis3=idiis3+(iterov-1)*nden                              1d27s25
             do i=0,nden-1                                              10d31s24
             ...
             write(6,*)('too many diis restarts!')                      1d27s25
             call dws_synca                                             1d27s25
             call dws_finalize                                          1d27s25
            end if                                                      1d27s25
           end if                                                       1d27s25
     ...
     $            iterov,(' of restart '),idiirest,                     1d28s25
     $          ('total no. of iterations '),iterovt                    1d28s25
   ...
   22        continue                                                     5d16s22
     ...
     $               jdend(idws)
             ...
             if(iterov.ge.2)then                                          5d17s22
              ...
              if(nden.gt.0)then                                         1d19s23
               if(iterov.gt.nprescf)then                                11d1s24
                if(iusenormal.gt.0)then                                 1d28s25
                 call lsqnormal(bc(ifmat),nden,iterm,bc(idata),nden,1,         5d19s22
     $        nden,bc(icoef),iterov,iret,aratio,bc,ibc)                 1d28s25
                 if(iret.ne.0)then                                      1d28s25
                  idiisrest=idiisrest+1                                 1d28s25
                  if(idiisrest.lt.5)then                                1d28s25
                   jdiis3=idiis3+(iterov-1)*nden                        1d28s25
                   do i=0,nden-1                                        1d28s25
                    bc(iden1d(1,1)+i)=bc(jdiis3+i)                      1d28s25
                   end do                                               1d28s25
                   go to 2122                                           1d28s25
                  else                                                  1d28s25
                   write(6,*)('diis iterations failed!')                1d28s25
                   call dws_synca                                       1d28s25
                   call dws_finalize                                    1d28s25
                   stop 'gradcasb'                                      1d28s25
                  end if                                                1d28s25
                 end if                                                 1d28s25
                 if(iusenormal.eq.2.and.mynowprog.eq.0)then             1d28s25
                  icoefsvd=ibcoff                                       1d28s25
                  ibcoff=icoefsvd+nden                                  1d28s25
                  call enough('gradcas.coefsvdb',bc,ibc)                1d28s25
                  call lsqfit2(bc(ifmat),nden,iterm,bc(idata),nden,1,   1d28s25
     $             nden,bc(icoefsvd),iterov,bc(iscr),bc(iwgt),0,rmsdiis,1d28s25
     $                 bc,ibc)                                          1d28s25
                  rmssvd=0d0                                            1d28s25
                  do i=0,iterm-1                                        1d28s25
                  ...
                  rmssvd=sqrt(rmssvd/dfloat(iterm))                     1d28s25
                  write(6,*)('gradcasb lsqnormal normal vs. svd: '),    1d28s25
     $                 rmssvd                                           1d28s25
                  if(rmssvd.gt.1d-10)                                     1d28s25
     $               write(6,*)('bad normal equations in gradcasb')     1d28s25
                  ibcoff=icoefsvd                                         1d28s25
                 end if                                                 1d28s25
                else                                                    1d28s25
     ...
     $          isblkderd,bc,ibc)                                       11d9s22
             ...
             if(lprint)                                                 4d13s23
     $       write(6,*)('diis calculations converged after iteration '),4d13s23
     $            iterov,(' of restart '),idiisrest,                    1d28s25
     $            (' total no. of iterations '),iterovt                 1d28s25
