...
c                                                                       1d8s21
     ...
     $     idenkn(4,4,8),iden1en(4),idenhvvn(4),tdendd(*),ioxx(2)       11d1s22
      ...
      integer*8 ibc0,ibcoffo,ibuff,iden1en,idenjn,idenkn,intden,iprod
     $itmp
     $itmp1,itmp2,itmpi,itrial,ndenjf,ndenkf
...
c     4 isbv1 isbv2   2   2
     ...
     $           i1s,i1e,i2s,i2e)                                       1d11s21
             ...
             if(min(nfdat(2,1,isb),nnn,nhere).gt.0)then                 4d24s25
              itmp=ibcoff                                                1d11s21
     ...
     d' hcddjk. 22')
             ...
             if(min(nfdat(2,1,isb),nnn).gt.0)then                       4d24s25
