...
c
     ...
     $     ionext(*),ioxx(2),ichvnotv(4),ic1vnotv(4,8,8)                11d9s22
      ...
      integer*8 ibcbmat,ibcgg,ibcvmat,ibmat,id1vnotv,id3vnotv3,idhvisv
     $idhvnotvf,idkeep,igg,igs,igtmp,intden,iprod,ipsr,ircv,itmp
     $itmpb,itmpdv,itmpnon,itmpsv,itmpv,itrans,ivmat
