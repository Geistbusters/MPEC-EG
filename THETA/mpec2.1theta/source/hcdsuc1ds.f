c mpec2.1 version theta. For copyright and Disclaimers, see start.f
      subroutine hcdsuc1ds(prod,ncsfs,ncsfd,ncsf2,xint,vs,gd,lsa,       8d2s21
     $     jsbv,isbv12,nvirt,multh,nrootu,nsymb,sr2,ldebug,bc,ibc)      11d14s22
      implicit real*8 (a-h,o-z)
      logical ldebug
      dimension prod(ncsfs,*),ncsf2(*),xint(*),vs(*),gd(*),             8d2s21
     $     nvirt(*),multh(8,8),nfdat(2),intden(2),itrans3(2),itrans(2)  6d11s21
      include "common.store"                                            6d10s21
      integer*8 intden,itmpdg,itmpdv,itrans,itrans2,ivst
      ...
      do l=1,2                                                          6d10s21
       ...
       call enough(' hcdsuc1ds.  1',bc,ibc)                                     6d10s21
      ...
      if(isbv12.eq.1)then                                               6d10s21
       ...
       call enough(' hcdsuc1ds.  2',bc,ibc)                                    6d10s21
       ...
       call enough(' hcdsuc1ds.  3',bc,ibc)                                    6d10s21
       ...
       do l=1,2                                                         6d10s21
        ...
        call enough(' hcdsuc1ds.  4',bc,ibc)                                    6d10s21
...
c     f v1 r v2, f v1 j, j r v2
           ...
           if(min(mcol,mrow).gt.0)then                                  8d24s21
            itmpdg=ibcoff                                                6d10s21
            ibcoff=itmpdg+mrow*mcol                                      6d10s21
            call enough(' hcdsuc1ds.  5',bc,ibc)                                6d10s21
            call dgemm('n','n',mrow,mcol,ncsfs,factt,bc(itrans3(l)),    8d24s21
     $           mrow,bc(ivst),ncsfs,0d0,bc(itmpdg),mrow)               8d24s21
...
c     f v1 r v2, f v2 j, j r v1
           ...
           if(min(mrow,mcol).gt.0)then                                  8d24s21
            itmpdv=ibcoff                                                6d10s21
            ibcoff=itmpdv+mrow*mcol                                      8d2s21
            call enough(' hcdsuc1ds.  6',bc,ibc)                                6d10s21
