c mpec2.1 version theta. For copyright and Disclaimers, see start.f
      subroutine hcdsuc1sd(prod,ncsfs,ncsfd,ncsf2,xint,gs,vd,lsa,       8d2s21
     $     jsbv,isbv12,nvirt,multh,nrootu,nsymb,sr2,ldebug,bc,ibc,igoul)      11d14s22
      implicit real*8 (a-h,o-z)
      logical ldebug
      dimension prod(ncsfs,*),ncsf2(*),xint(*),gs(*),vd(*),             8d2s21
     $     nvirt(*),multh(8,8),nfdat(2),intden(2),itrans3(2),itrans(2)  6d11s21
      include "common.store"                                            6d10s21
      integer*8 intden,itmpdv,itmpsg,itrans,itrans2,ivdt
      ...
      do l=1,2                                                          6d10s21
       ...
       call enough(' hcdsuc1sd.  1',bc,ibc)
      ...
      if(isbv12.eq.1)then                                               6d10s21
       ...
       call enough(' hcdsuc1sd.  2',bc,ibc)
       ...
       do l=1,2                                                         6d10s21
        ...
        ibcoff=intden(l)+nvirt(lsa)*ncsfs*nfdat(l)                      8d2s21
        call enough(' hcdsuc1sd.  3',bc,ibc)
...
c     f v1 r v2, f v1 j, j r v2
           ...
           call enough(' hcdsuc1sd.  4',bc,ibc)
           do id=0,nfdat(l)-1                                           6d10s21
            idp=id+iaddd                                                6d10s21
            do ir=0,nrootu-1                                            6d10s21
             do iv2=0,nvirt(isbv2)-1                                    6d10s21
     ...
     $              +nvirt(isbv2)*ir))                                  6d10s21
           ...
           if(min(mcol,mrow).gt.0)then                                  8d24s21
            ...
            call enough(' hcdsuc1sd.  5',bc,ibc)
            call dgemm('n','n',ncsfs,mcol,mrow,factt,bc(intden(l)),     8d24s21
     $           ncsfs,bc(ivdt),mrow,0d0,bc(itmpsg),ncsfs)              8d24s21
...
c     f v1 r v2, f v2 j, j r v1
           ...
           if(min(mrow,mcol).gt.0)then                                  8d24s21
            ...
            call enough(' hcdsuc1sd.  6',bc,ibc)
