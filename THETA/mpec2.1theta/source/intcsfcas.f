c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $     mynnode                                                      5d15s19
      ...
      integer*8 ibcoffo,ibctop,iegn,ieigold,ieigp,ihcpy,ihdcopy,ihdig
     $ihdigps,ihps,ilzps,ilzzdig,ilzzpsdig,ipointf,ipointp,ipsbase
     $isbasis,ivecx,ivecxsave,ivsave,jsto
