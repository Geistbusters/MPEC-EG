c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $     maxdiis,maxrest,iusenormalci)                                1d28s25
...
c
       ...
       do irt=0,nrootm                                                   4d12s23
        ...
        if(iusenormalci.gt.0)then                                       1d28s25
         call lsqnormal(bc(ifmat),nct,nfit,bc(jrhs),nct,1,nct,             8d25s23
     $      bc(icoef),nfit,iret,aratio,bc,ibc)                          1d28s25
         if(iret.ne.0)then                                              1d28s25
          write(6,*)('lsqnormal failed in intcsfder '),aratio           1d28s25
          call dws_synca                                                1d28s25
          call dws_finalize                                             1d28s25
          stop 'intcsfder'                                              1d28s25
         end if                                                         1d28s25
         if(iusenormalci.eq.2.and.mynowprog.eq.0)then                   1d28s25
          icoefsvd=ibcoff                                               1d28s25
          ibcoff=icoefsvd+nfit                                          1d28s25
          call enough('intcsfder.coefsvd',bc,ibc)                       1d28s25
          call lsqfit2(bc(ifmat),nct,nfit,bc(jrhs),nct,1,nct,           1d28s25
     $      bc(icoefsvd),nfit,bc(iscr),bc(iwgt),0,rms,bc,ibc)           1d28s25
          ...
          write(6,*)('intcsfder lsqnormal normal vs. svd: '),rmssvd     1d28s25
          if(rmssvd.gt.1d-10)                                           1d28s25
     $        write(6,*)('bad normal equations in intcsfder!!!'),aratio 1d28s25
         end if                                                         1d28s25
        else                                                            1d28s25
