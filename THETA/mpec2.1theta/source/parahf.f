...
c
     ...
     $          itpmat(8),itqmat(8),j2den(idbk),itotm(8),itotmb(8)      4d5s18
      ...
      integer*8 iamat1,iamat10,iaseward,ibc404,ibcb4,ibcode,ibcreset
     ...
     $imxmx,inbasg,inuq,inuqg,iorb,iorbn,ios,ipao
     ...
     $ixrt,ixsb,iyc,iztmp,nveccnt
      dimension ioooo2(idbk),jmatd(idbk),kmatd(idbk),iooood(idbk),      2d23s16
...
c
 ...
 1329   format('nocc :',8i5)                                            6d12s23
        ...
        if(iprtr(34).ne.0)then                                          1d1s25
         write(6,*)('input cartesians: ')                               1d1s25
         call prntm2(xcart,3,natom,3)                                   1d1s25
        end if                                                          1d1s25
       end if
     ...
     $       isb=1,nsymb),nlzzg                                         5d4s23
        ...
        do isb=0,nsymbg-1                                               2d18s16
         ...
         if(myguessi.eq.2.and.ngausg.eq.ngaus)then                      4d28s21
          ...
          nhc=ibc(inbasg+isb)
          sz=0d0                                                        1d23s25
          do i=0,nhr*nhc-1                                              1d23s25
           sz=sz+bc(jvguess+i)**2                                       1d23s25
          end do                                                        1d23s25
          sz=sqrt(sz/dfloat(nhr*nhc))                                   1d23s25
          if(sz.lt.1d-5)then                                            1d23s25
           write(6,*)('sz = '),sz
           write(6,*)('looks like we have no orthogonal vectors to use')1d23s25
           write(6,*)('use ao vectors instead')                         1d23s25
           nhr=ncompg*ibc(inbasgp+isb)
           do i=0,nhr*nhc-1                                             1d23s25
            bc(jvguess+i)=bc(ivdum+i)                                   1d23s25
           end do                                                       1d23s25
           jvguess=jvguess+nhr*nhc                                      1d23s25
           myguessi=1                                                   1d23s25
           write(6,*)('set myguessi to '),myguessi
          else                                                          1d23s25
           jvguess=jvguess+nh                                            2d15s19
          end if                                                        1d23s25
         else                                                           2d18s16
...
c
         if((myguessi.eq.1.and..not.(idorel.ne.0.and.(myguess.or.       1d23s25
     $        (icas.ne.0.and.icasguess.ne.1)))).or.nrydb.ne.0)then      1d23s25
     ...
     $           ibc)                                                   12d4s22
          ...
          if(nvguess.lt.0)then                                          10d12s22
           ...
           if(nbasisc(isb).eq.nbasisp(isb)*2)then                       2d2s23
            ...
            if(myguessi.eq.1)then                                       1d27s25
             ivecold=ivecold+ncomp*                                     1d27s25
     $           iabs(nvguess)*nbasdws(isb)*nbasisp(isb)                1d27s25
            else                                                        1d27s25
      ...
      do isb=1,nsymb                                                    6d28s04
       ...
       if(nbas4.gt.0)then
        if(iter1.eq.1)then                                              9d9s04
         ...
         call dgemm('t','n',nbas4,nbas4,nbas4,1d0,bc(iorbx(isb)),nbas4,
     $         bc(iorbx(isb)),nbas4,0d0,bc(ibcoff),nbas4)
         otest=0d0                                                      1d23s25
         do i=0,nbas4-1                                                 1d23s25
          do j=0,i-1                                                    1d23s25
           ji=ibcoff+j+nbas4*i                                          1d23s25
           ij=ibcoff+i+nbas4*j                                          1d23s25
           otest=otest+bc(ji)**2+bc(ij)**2                              1d23s25
          end do                                                        1d23s25
          ii=ibcoff+i+nbas4*i                                           1d23s25
          otest=otest+(bc(ii)-1d0)**2                                   1d23s25
         end do                                                         1d23s25
         otest=sqrt(otest)/dfloat(nbas4)                                1d23s25
         call dws_bcast(otest,1)                                        1d23s25
         if(otest.gt.1d-6)then                                          1d23s25
          write(6,*)                                                    1d23s25
     $        ('orthogonality test failed for vectors of symmetry'),isb  1d23s25
          write(6,*)('otest: '),otest                                    1d23s25
          call prntm2(bc(ibcoff),nbas4,nbas4,nbas4)                     1d23s25
          write(6,*)('orbs in orthogonal basis '),iorbx(isb),ibcoff
          call prntm2(bc(iorbx(isb)),nbas4,nbas4,nbas4)                 1d30s18
          call dws_synca                                                1d23s25
          call dws_finalize                                             1d23s25
          stop 'parahf'                                                 3d10s25
         end if                                                         1d23s25
...
c                         567 890         705869
 ...
 1351     format(20es14.5)
     ...
     $          isinfo,ibc(nveccnt),icannon,iusenormal)                 1d28s25
          end if                                                         5d4s22
