...
c
     ...
     $     iopdata(7,*),iosym(*),multh(8,8),nbasisp(8),iorbb(8),         5d27s21
     $     nbasdwx(8),ixyz(3,3),xcartb(3),xcartk(3),iorbk(8)            2d3s25
      ...
      write(6,*)('ibdatb '),ibdatb
      call prntm2(bc(ibdatb),ngaus,8,ngaus)
      write(6,*)('ibdatk '),ibdatk
      call prntm2(bc(ibdatk),ngaus,8,ngaus)
      write(6,*)('bstor: '),(ibstor(i),i=1,20)
      write(6,*)('sstor: '),(ibstor(i),i=1,20)
       write(6,*)('nbasisp: '),(nbasisp(isb),isb=1,nsymb)
       write(6,*)('nbasdwx: '),(nbasdwx(isb),isb=1,nsymb)
       write(6,*)('iorbk: '),(iorbk(isb),isb=1,nsymb)
       write(6,*)('iorbb: '),(iorbb(isb),isb=1,nsymb)
      end if                                                            5d25s18
      call second(time1)
c
...
c
      ...
      j12=i12                                                           2d19s10
      jbdatb=ibdatb-1                                                   2d3s25
      jbdatk=ibdatk-1                                                   2d3s25
 ...
 5515  format(i5,5x,3i5)
      ...
      do i1=1,ngaus                                                     2d19s10
       do i2=1,ngaus                                                    12d16s19
        ibc(j12)=-((ibc(jbdatb+i1)+ibc(jbdatk+i2)+2)**2)                2d3s25
        if(iapair(1,ibc(jbdatb+i1+ngaus7)).gt.0)ibc(j12)=ibc(j12)*2     2d3s25
        if(iapair(1,ibc(jbdatk+i2+ngaus7)).gt.0)ibc(j12)=ibc(j12)*2     2d3s25
    ...
    1  format(i5,i8,2i5)                                                2d19s10
      ...
      telap=time2-time1
      loopit=0                                                          5d25s18
      if(idwsdeb.gt.10)write(6,*)('nneed = '),nneed
    ...
    2  format('I am going to do ',i5,3i3,f18.5)                               2d19s10
       ...
       jket=jbdatk+ibc(jpair+1)                                         2d3s25
...
c
      do iopr=1,nop                                                     12d15s19
       do isb=1,nsymb                                                   12d15s19
        ...
        if(isk.lt.1.or.isk.gt.nsymb)stop 'parap2'
     ...
     $       .gt.0)then                                                 12d16s19
         if(idwsdeb.ne.0)then                                           10d31s20
          ...
          write(6,*)('in primitive basis: '),nbasisp(isb),nbasisp(isk),
     $         ncomp
          call prntm2(bc(ixmt(isb,iopr)),nbasisp(isb)*ncomp,             3d3s20
     $        nbasisp(isk)*ncomp,nbasisp(isb)*ncomp)                    3d3s20
          write(6,*)('using vectors '),iorbk(isk),loc(bc(iorbk(isk)))
          call prntm2(bc(iorbk(isk)),nbasisp(isk)*ncomp,nbasdwx(isk),   2d3s25
     $         nbasisp(isk)*ncomp)
         end if                                                         10d31s20
     ...
     $       1d0,bc(ixmt(isb,iopr)),nbasisp(isb)*ncomp,bc(iorbk(isk)),  2d3s25
     ...
     d' parap.  1')
         ...
         if(idwsdeb.ne.0)then                                           2d14s25
          write(6,*)('half transformed, transposed: ')
          call prntm2(bc(ixmt(isb,iopr)),nbasdwx(isk),
     $         nbasisp(isb)*ncomp,nbasdwx(isk))
          write(6,*)('using bra orbitals ')
          call prntm2(bc(iorbb(isb)),nbasisp(isb)*ncomp,nbasdwx(isb),
     $         nbasisp(isb)*ncomp)
         end if                                                         2d14s25
         call dgemm('n','n',nbasdwx(isk),nbasdwx(isb),
     $        nbasisp(isb)*ncomp,                                       1d11s20
     $        1d0,bc(ixmt(isb,iopr)),nbasdwx(isk),bc(iorbb(isb)),       2d3s25
