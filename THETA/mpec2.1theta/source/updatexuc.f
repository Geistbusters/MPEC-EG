...
c
     ...
     $     mynnode                                                      5d24s18
      data icall/0/
      save
      integer*8 ibcoffo,igtmp,ivdtry,ivec,ivecd,ivecs,ivstest
      i1=1                                                              11d10s20
      icall=icall+1
      ibcoffo=ibcoff
     ...
     $        bc(ivecd))                                                11d15s22
         ...
         if(lprint)then                                                 3d26s25
          write(6,*)('visv vec for '),jsb,jsbv1,jsbv2,ii
          call prntm2(bc(ivecd),nrow,nhere,nrow)                        3d26s25
          write(6,*)('visv H*vec ')                                     3d26s25
          call prntm2(bc(igd),nrow,nhere,nrow)                          3d26s25
         end if                                                         3d26s25
         jvecd=ivecd                                                    6d9s21
         jgd=igd                                                        6d9s21
         do iff=il,ih                                                   6d9s21
