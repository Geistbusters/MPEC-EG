      ...
      do iv=1,nvec
       if(iradau(iv).eq.0)then
        if(nvec.eq.2.and.nblba.eq.2)then                                9d10s19
         ...
         if(iv.eq.1)then                                                2d12s25
          xblbat=xm(1)+xm(2)+xm(3)                                      2d12s25
          xblba1=xm(nends(1,1,iv))                                      2d12s25
          xblba2=xblbat-xblba1                                          2d12s25
          coord(iv,1)=xblba2/xblbat                                     2d12s25
          coord(iv,2)=-xblba1/xblbat                                    2d12s25
          coord(iv,3)=coord(iv,2)                                       2d12s25
         else                                                           2d12s25
          xblbat=xm(1)+xm(2)+xm(3)                                      2d12s25
          xblba1=xm(nends(1,2,iv))                                      2d12s25
          xblba2=xblbat-xblba1                                          2d12s25
          coord(iv,3)=xblba2/xblbat                                     2d12s25
          coord(iv,2)=-xblba1/xblbat                                    2d12s25
          coord(iv,1)=coord(iv,2)                                       2d12s25
         end if                                                         2d12s25
        else                                                            9d10s19
...
c
  ...
  996     continue                                                       3d25s94
      ...
      do i=1,natom-1                                                    2d12s25
       sum=0d0                                                          2d12s25
       do ia=1,natom                                                    2d12s25
        sum=sum+xm(ia)*coord(i,ia)*coord(natom,ia)                      2d12s25
       end do                                                           2d12s25
      end do                                                            2d12s25
c
...
c
      ...
      if(nvec.gt.1)then                                                 4d12s19
       ...
       if(ibisect.eq.0)then                                             2d14s25
        ca=cos(rjac(1,2))                                                4d12s19
        sa=sin(rjac(1,2))                                                4d12s19
        cart(1,2)=rjac(2,1)*sa                                           4d12s19
        cart(3,2)=rjac(2,1)*ca                                           4d12s19
       else                                                             2d14s25
        write(6,*)('using angle bisector ')                             2d14s25
        ca=cos(0.5d0*rjac(1,2))                                         2d14s25
        sa=sin(0.5d0*rjac(1,2))                                         2d14s25
        if(ibsect.eq.1)then                                             2d21s25
         cart(1,1)=-rjac(1,1)*sa                                         2d14s25
         cart(3,1)=rjac(1,1)*ca                                           2d14s25
         cart(1,2)=rjac(2,1)*sa                                          2d14s25
         cart(3,2)=rjac(2,1)*ca                                          2d14s25
        else                                                            2d21s25
         cart(3,1)=-rjac(1,1)*sa                                        2d21s25
         cart(1,1)=rjac(1,1)*ca                                         2d21s25
         cart(3,2)=rjac(2,1)*sa                                         2d21s25
         cart(1,2)=rjac(2,1)*ca                                         2d21s25
        end if                                                          2d21s25
       end if                                                           2d14s25
