     ...
     $     m1c,idatac,idatbc,mst,mnz,nz,lbail,bc,ibc,iv,bc(ie))         4d7s23
      ...
      do irt=0,nrootm                                                   4d12s23
       ...
       if(iusenormal.ne.0)then                                          1d28s25
        call lsqnormal(bc(ifmat),ncona,nfit,bc(idat),ncona,1,ncona,     1d28s25
     $      bc(icoef),nfit,iret,aratio,bc,ibc)                          1d28s25
        if(iret.ne.0)then                                               1d28s25
         write(6,*)('lsqnormal iret = '),iret                           1d28s25
        ...
        if(iusenormal.eq.2)then                                         1d28s25
         ...
         ibcoff=icoefsvd+nfit                                           1d28s25
         call enough('cgvec2.coefsvd',bc,ibc)                           1d28s25
         call lsqfit2(bc(ifmat),ncona,nfit,bc(idat),ncona,1,ncona,      1d28s25
     $      bc(icoefsvd),nfit,bc(iscr),bc(iwgt),0,rms,bc,ibc)           1d28s25
         rmssvd=0d0                                                     1d28s25
         sz=0d0                                                         1d28s25
         do i=0,nfit-1                                                  1d28s25
          rmssvd=rmssvd+(bc(icoef+i)-bc(icoefsvd+i))**2                 1d28s25
          sz=sz+bc(icoef+i)**2                                          1d28s25
         end do                                                         1d28s25
         rmssvd=sqrt(rmssvd/dfloat(nfit))                               1d28s25
         sz=sqrt(sz/dfloat(nfit))                                       1d28s25
         if(mynowprog.eq.0)                                             1d28s25
     $        write(6,*)('cgvec2 lsqnormal normal vs. svd: '),rmssvd,sz         1d28s25
         if(rmssvd.gt.1d-10.and.mynowprog.eq.0)                         1d28s25
     $        write(6,*)('bad normal equations in cgvec2!!!'),aratio    1d28s25
