c mpec2.1 version theta. For copyright and Disclaimers, see start.f
     ...
     $      (bc(idenergy+i),i=0,nder-1)
      ...
      itrans=idata+natom3*natom3                                        1d3s25
      if(ldebug)then                                                    3d14s23
...
c     rotate to standard orientation
           if(natom.gt.3)then                                           1d1s25
            r1=0d0                                                       1d1s25
            do ixyz=0,2                                                  1d1s25
             r1=r1+bc(icpy+ixyz)**2                                      1d1s25
            end do                                                       1d1s25
            r1=sqrt(r1)                                                  1d1s25
            r1i=1d0/r1                                                   1d1s25
            cbeta=bc(icpy+2)*r1i                                         1d1s25
            sbeta=sqrt(abs(1d0-cbeta*cbeta))                             1d1s25
            alpha=atan2(bc(icpy+1),bc(icpy))                             1d1s25
            ca=cos(alpha)                                                1d1s25
            sa=sin(alpha)                                                1d1s25
            tryx=r1*sbeta*ca                                             1d1s25
            tryy=r1*sbeta*sa                                             1d1s25
            try=sqrt((bc(icpy)-tryx)**2+(bc(icpy+1)-tryy)**2)            1d1s25
            if(try.gt.1d-8)then                                          1d1s25
             alpha=alpha+pi                                              1d1s25
             ca=cos(alpha)                                              1d13s25
             sa=sin(alpha)                                              1d13s25
             tryx=r1*sbeta*ca                                             1d1s25
             tryy=r1*sbeta*sa                                             1d1s25
             try=sqrt((bc(icpy)-tryx)**2+(bc(icpy+1)-tryy)**2)            1d1s25
             if(try.gt.1d-7)then                                         1d1s25
              write(6,*)('2 strikes and we''re out!! '),tryx,tryy,       1d1s25
     $           bc(icpy),bc(icpy+1)                                    1d1s25
              call dws_synca                                             1d1s25
              call dws_finalize                                          1d1s25
              stop                                                       1d1s25
             end if                                                      1d1s25
            end if                                                       1d1s25
            rm(1,1)=cbeta*ca                                            1d1s25
            rm(2,1)=-sa                                                 1d2s25
            rm(3,1)=ca*sbeta                                            1d2s25
            rm(1,2)=sa*cbeta                                            1d2s25
            rm(2,2)=ca                                                  1d1s25
            rm(3,2)=sa*sbeta                                            1d2s25
            rm(1,3)=-sbeta                                              1d2s25
            rm(2,3)=0d0                                                 1d2s25
            rm(3,3)=cbeta                                               1d1s25
            if(ldebug)then                                              1d6s25
             write(6,*)('rotation matrix ')                              1d1s25
             call prntm2(rm,3,3,3)                                       1d1s25
            end if                                                      1d6s25
            ixtmp=ibcoff                                                 1d1s25
            ibcoff=ixtmp+3*natom                                         1d1s25
            call enough('move2min.xtmp',bc,ibc)                          1d1s25
            call dgemm('n','n',3,natom,3,1d0,rm,3,bc(icpy),3,0d0,        1d1s25
     $          bc(ixtmp),3,'move2min.xtmp')                            1d1s25
            if(ldebug)then                                              1d6s25
             write(6,*)('after step 1: ')                                 1d1s25
             call prntm2(bc(ixtmp),3,natom,3)                             1d1s25
            end if                                                      1d6s25
            try=sqrt(bc(ixtmp)**2+bc(ixtmp+1)**2)                       1d2s25
            if(try.gt.1d-7)then                                         1d2s25
             write(6,*)('failed step 1!!!'),try                             1d2s25
             stop                                                       1d2s25
            end if                                                      1d2s25
            do ixi=0,3*natom-1                                             1d1s25
             bc(icpy+ixi)=bc(ixtmp+ixi)                                      1d1s25
            end do                                                       1d1s25
            r2=0d0                                                       1d1s25
            do ixyz=3,5                                                  1d1s25
             r2=r2+bc(icpy+ixyz)**2                                      1d1s25
            end do                                                       1d1s25
            r2=sqrt(r2)                                                  1d1s25
            r2i=1d0/r2                                                   1d1s25
            cchi1=bc(icpy+5)*r2i                                         1d1s25
            schi1=sqrt(abs(1d0-cchi1*cchi1))                             1d1s25
            gamma=atan2(bc(icpy+4),bc(icpy+3))                           1d1s25
            cg=cos(gamma)                                                1d1s25
            sg=sin(gamma)                                                1d1s25
            tryx=r2*schi1*cg                                             1d1s25
            tryy=r2*schi1*sg                                             1d1s25
            try=sqrt((tryx-bc(icpy+3))**2+(tryy-bc(icpy+4))**2)          1d1s25
            if(try.gt.1d-8)then                                          1d1s25
             gamma=gamma+pi                                              1d1s25
             cg=cos(gamma)                                                1d1s25
             sg=sin(gamma)                                                1d1s25
             tryx=r2*schi1*cg                                             1d1s25
             tryy=r2*schi1*sg                                             1d1s25
             try=sqrt((tryx-bc(icpy+3))**2+(tryy-bc(icpy+4))**2)          1d1s25
             if(try.gt.1d-7)then                                          1d1s25
              write(6,*)('2 strikes and we''re outb!! '),tryx,tryy,     1d1s25
     $           bc(icpy+3),bc(icpy+4)                                  1d1s25
              call dws_synca                                            1d1s25
              call dws_finalize                                         1d1s25
              stop                                                      1d1s25
             end if                                                      1d1s25
            ...
            call dgemm('n','n',3,natom,3,1d0,rm,3,bc(icpy),3,0d0,        1d1s25
     $          bc(ixtmp),3,'move2min.xtmpb')                           1d1s25
            if(ldebug)then                                              1d6s25
             write(6,*)('after step 2: ')                                 1d1s25
             call prntm2(bc(ixtmp),3,natom,3)                             1d1s25
            end if                                                      1d6s25
            if(abs(bc(ixtmp+4)).gt.1d-8)then                            1d2s25
             write(6,*)('failed step 2!!!')                             1d2s25
             call prntm2(bc(ixtmp),3,natom,3)                             1d1s25
             call dws_synca                                             1d2s25
             call dws_finalize                                          1d2s25
             stop                                                       1d2s25
            end if                                                      1d2s25
            do ixi=0,3*natom-1                                             1d1s25
             bc(icpy+ixi)=bc(ixtmp+ixi)                                      1d1s25
     ...
     $       dex                                                        3d14s23
        ...
        dotxf=0d0
        if(ldebug)write(6,*)('dir   xk+1   xk   sk   gradk+1 gradk yk')
        do i=0,nunique-1                                                3d14s23
