c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine deconvert2torc(iff22,nff22,nfdat,ncsf,ncsf2,           8d9s21
     $     isymmrci,nvirt,nroot,mdon,mdoop,nsymb,multh,ntot,gunc,       8d9s21
     $     ff22,mdoub,nff0,gc,ndoub,bc,ibc)                             11d10s22
     ...
     $     nff20(mdoop,3),nff0(mdoop,3),                                8d9s21
...
c     iad2 is ncsf2xnl
     ...
     $                (iff22(iad1+iii)-1))                              8d9s21
                 do i=0,ncsf2(1,iarg)-1                                  8d9s21
                  ...
                  if(abs(orig-gc(igoal)).gt.1d-10)write(6,*)
     $                 ('goalvisv '),
     ...
     $           ioffgd
      ...
      call enough('deconvert2torc.  1',bc,ibc)
