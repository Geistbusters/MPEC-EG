c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine doab1non(idat1a,n1a,idat1b,n1b,g,nhere,ilc,ihc,cvec,   7d25s22
     $     nadet,i2e,ism,irelo,iacto,iu1,iu2,ju1,ju2,ipxder,bc,ibc,     3d27s23
     $     igoal,nroot)                                                 3d27s23
      ...
      dimension cvec(nroot,nadet,*),g(nroot,nhere,*),                   3d27s23
      ...
      do ja=1,n1a
       ...
       if(jjb.ge.ilc.and.jjb.le.ihc)then                                6d15s22
        ...
        do ib=1,n1b
         ...
         val=pa*phs(idat1b(4,ib))*bc(iadc)                              6d15s22
         do k=1,nroot                                                   3d27s23
          g(k,jjbr,iib)=g(k,jjbr,iib)+val*cvec(k,jjk,iik)               3d27s23
         end do                                                         3d27s23
        end do                                                          6d15s22
       end if                                                           6d15s22
      end do
