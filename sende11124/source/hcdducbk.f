c mpec2.1 version eta. For copyright and Disclaimers, see start.f
      subroutine hcdducbk(ihddiagb,ihddiagk,nff2b,iff2b,nff2k,iff2k,    8d24s21
     $     ncsf,ncsf2,nec,                                              8d24s21
     $     mdon,mdoop,nsymb,multh,ixw1,ixw2,ixmtf,lxmt,phase1,isymop,   7d23s21
     $     n2e,ixmt,i2eop,phase2,nvirt,nrootu,ism,                      7d23s21
     $    irel,irefo,isymbra,isymket,norb,lprt,maxbxd,sr2,srh,timex,    7d23s21
     $     tovr,idoubo,nbasdws,izero,bc,ibc,nwiacc)                     1d27s23
      implicit real*8 (a-h,o-z)
      external second                                                   2d18s21
      integer*8 ihddiagb(mdoop,nsymb),ihddiagk(mdoop,nsymb,2),i18,i28,  8d21s21
     $     i38,i48,i2c,i2o,j2c,j2o,itestc,itesto,last8(2),k2o,l2o       7d23s21
      integer*1 nab1(2),nab2(2),nab1b(2),nab2b(2)                       2d19s21
      logical lkeep,lprt,lchoice,log(4)                                        3d17s21
      dimension nff2b(mdoop,nsymb,2),ncsf(*),multh(8,8),ixmtf(*),        7d23s21
     $     isymop(*),ixmt(8,*),nvirt(*),ism(*),irel(*),                 7d23s21
     $     itest(32,3),isorb2(32),idorb2(32),jsorb2(32),jdorb2(32),     6d22s21
     $     nab4(2,3),idenj(8),idenk(8,2),irefo(*),iff2b(*),ndenj(8),    8d24s21
     $     ndenk(8),idenjk(8),ndenjk(8),ncsf2(*),idoubo(*),             7d23s21
     $     ivec(7,8),ivecp(7,8),nvecp(8),ircv(7,8),nrcv(7,8),           6d22s21
     $     mdenjk(8),idenjkc(8),mdenj(8),idenjc(8),mdenk(8),            6d23s21
     $     idenkc(8),ww(5),i2eop(2,3),nbasdws(*),                       7d23s21
     $     itransv(7,8),mtmpx(4),ntmpx(4,8),itmpx(4,8),jtmpx(4,8),      8d24s21
     $     nff2k(mdoop,nsymb,2),iff2k(*)                                 8d24s21
     ...
     $     mynnode                                                      5d24s18
      ...
      if(izero.ne.0)then                                                1d24s21
       do isb=1,nsymb                                                    11d26s20
        do ii=mdon+1,mdoop                                              7d22s21
         if(ihddiagb(ii,isb).ge.0)then                                  8d21s21
          call ddi_zero(bc,ibc,ihddiagb(ii,isb))                        11d15s22
         end if                                                          11d26s20
        end do                                                          6d8s21
       end do                                                            11d26s20
       call dws_synca                                                    6d11s21
      end if                                                            1d24s21
      mdoo=mdoop-1                                                      7d23s21
      iacc=ibcoff                                                       2d12s21
      ...
      do isb=1,nsymb                                                    12d12s20
       isbv12=multh(isb,isymbra)                                        7d23s21
       mvisv=0                                                          6d21s21
       mvnotv=0                                                         6d21s21
       ...
       do ncloip=mdon+1,mdoop                                           7d23s21
        if(min(nff2b(ncloip,isb,1),mvisv+mvnotv).gt.0)then               6d21s21
         ncloi=ncloip-1                                                  12d12s20
         iarg=ncloip-mdon                                                12d12s20
         mrow=(ncsf2(iarg)*mvisv+ncsf(iarg)*mvnotv)*nrootu              7d23s21
         nopeni=nec-2*ncloi                                              12d12s20
         nopenim=nopeni-1                                               6d21s21
         if(ncloip.eq.4.and.isb.eq.4)then
         ...
         do jsb=1,nsymb                                                   12d12s20
          jsbv12=multh(jsb,isymket)                                     7d23s21
          ijsb=multh(isymop(lxmt),multh(jsbv12,isbv12))                 8d19s21
          nvisv=0                                                       6d21s21
          nvnotv=0                                                      6d21s21
          ...
          nmrow=nrootu*(ncsf2(iarg)*nvisv+ncsf(iarg)*nvnotv)            7d23s21
          nmrowk=nrootu*ncsf(iarg)*(nvisv+nvnotv)                       7d1s21
          nmrowk2=nmrowk*2                                              7d2s21
          do nclojp=max(mdon+1,ncloip-2),min(mdoop,nctop)               7d23s21
           if(min(nff2k(nclojp,jsb,1),nvisv+nvnotv).gt.0)then            6d21s21
            idoit=mod(idoit,mynprocg)                                   1d30s23
            ncloj=nclojp-1                                               12d12s20
            jarg=nclojp-mdon                                             12d12s20
            nopenj=nec-2*ncloj                                           12d14s20
            nrow=(ncsf2(jarg)*nvisv+ncsf(jarg)*nvnotv)*nrootu           7d23s21
            ivecbc=ibcoff                                               2d12s21
            call ilimts(1,nff2k(nclojp,jsb,1),mynprocg,mynowprog,ilf,    6d22s21
...
c
            ...
            if(min(nrow,nfhere).gt.0)then                               8d24s21
             call ddi_iget(bc,ibc,ihddiagk(nclojp,jsb,1),i18,i28,i38,   11d15s22
     $           i48,bc(ivec(nuse,jsb)),ibc(ircv(nuse,jsb)),            11d15s22
     $           nrcv(nuse,jsb))                                        11d15s22
            else                                                        8d24s21
             nrcv(nuse,jsb)=0                                           8d24s21
            end if                                                      8d24s21
   22       continue                                                    2d12s21
            if2o=nff2b(ncloip,isb,2)                                      12d14s20
            ...
            call enough('hcdducbk.  2',bc,ibc)
            jgg=igg                                                     12d14s20
            jvecer=0                                                    2d12s21
            do if2=1,nff2b(ncloip,isb,1)                                  12d14s20
             call second(timex)
             ntkeep=0                                                   8d20s21
             do i=idenstrt,idenend                                      6d22s21
              bc(i)=0d0                                                 6d22s21
             end do                                                     6d22s21
             i2c=iff2b(if2o)                                                11d25s20
             ntest=popcnt(i2c)
             if(ntest.ne.ncloi)then
              write(6,*)('ntest = '),ntest,if2
...
c     re-order it to nvv,nroot,ncsf,iff2                                6d21s21
                  ...
                  do jsbv1=1,nsymb                                               6d9s21
                   ...
                   if(jsbv2.ge.jsbv1)then                                        6d9s21
                    if(jsbv1.eq.jsbv2)then                                       6d9s21
                     ...
                     nhere=nvirt(jsbv1)*ncsf2(jarg)*nrootu              7d23s21
                ...
                if(itransgg.eq.0.and.nnot.gt.0)then                       6d21s21
                 ...
                 itransgg=1                                                2d12s21
                 do i=igg,igg+mrow*nff2b(ncloip,isb,1)-1                   6d21s21
                  bc(i)=0d0                                                2d12s21
                 end do                                                    2d12s21
                end if                                                     2d12s21
...
c     we already have everything, independent of csf, except for 4v.
     ...
     $                   bc,ibc)                                        11d10s22
                   ...
                   if(i1.lt.nopenim.and.i2.lt.nopenim)then                6d21s21
                    xint=0d0                                            7d26s21
                    do ii2e=1,n2e                                       7d26s21
                     if(multh(lsa,lsb).eq.isymop(i2eop(1,ii2e)))then    7d26s21
                      iab=ixmt(lsa,i2eop(1,ii2e))                       7d26s21
     $                   +lga+idoubo(lsa)+nbasdws(lsa)*(lgb+idoubo(lsb))7d26s21
                      icd=ixmt(lsc,i2eop(2,ii2e))                       7d26s21
     $                   +lgc+idoubo(lsc)+nbasdws(lsc)*(lgd+idoubo(lsd))7d26s21
                      xint=xint+bc(iab)*bc(icd)                         7d26s21
                     end if                                             7d26s21
                    end do                                              7d26s21
                    xint=xint*phase2                                    7d26s21
                    do i=0,nnm                                           6d21s21
...
c     bra is i, ket is j
     ...
     $                ncsfmid1,bc,ibc)                                  11d14s22
                 ...
                 call enough('hcdducbk.  6',bc,ibc)
                 call prodn(iwpb1,iwpk1,ncsf(iarg),ncsf(jarg),ncsfmid1,  6d22s21
     $               bc(iprod),bc,ibc,1d0,0d0)                          2d13s23
                 isa=ism(nab1(1))                                        6d22s21
                 issb=ism(nab1(2))                                      7d23s21
                 iga=irel(nab1(1))-1                                     6d22s21
                 igb=irel(nab1(2))-1                                     6d22s21
                 igap=iga+idoubo(isa)                                   7d23s21
                 igbp=igb+idoubo(issb)                                  7d23s21
                 if(multh(isa,issb).eq.isymop(lxmt))then                7d23s21
                  ih0=ixmtf(isa)+igap+nbasdws(isa)*igbp                 7d23s21
                  sum=bc(ih0)*phase1                                    7d23s21
                 else                                                   7d23s21
                  sum=0d0                                               7d23s21
                 end if                                                 7d23s21
                 do i=1,norb                                                   11d25s20
                 ...
                 do i=1,nok                                                    11d13s20
                  ...
                  if(itest(i,3).eq.2)then                                  12d14s20
                   ...
                   xj=0d0                                               7d26s21
                   do ii2e=1,n2e                                        7d26s21
                    if(1.eq.isymop(i2eop(2,ii2e)).and.isa.eq.issb)then  7d26s21
                     iab=ixmt(isa,i2eop(1,ii2e))                        7d26s21
     $                  +iga+idoubo(isa)+nbasdws(isa)*(igb+idoubo(issb))7d26s21
                     icd=ixmt(js,i2eop(2,ii2e))                         7d26s21
     $                   +(jg+idoubo(js))*(nbasdws(js)+1)               7d26s21
                     xj=xj+bc(iab)*bc(icd)                              7d26s21
                    end if                                              7d26s21
                   end do                                               7d26s21
                   xj=xj*phase2                                         7d26s21
                   xk=0d0                                               7d26s21
                   do ii2e=1,n2e                                        7d26s21
                    if(multh(isa,js).eq.isymop(i2eop(1,ii2e)).and.
     $                 multh(issb,js).eq.isymop(i2eop(2,ii2e)))then     7d26s21
                     iaj=ixmt(isa,i2eop(1,ii2e))                        7d26s21
     $                  +iga+idoubo(isa)+nbasdws(isa)*(jg+idoubo(js))   7d26s21
                     ibj=ixmt(js,i2eop(2,ii2e))                         7d26s21
     $                  +jg+idoubo(js)+nbasdws(js)*(igb+idoubo(issb))   7d26s21
                     xk=xk+bc(iaj)*bc(ibj)                              7d26s21
                    end if                                              7d26s21
                   end do                                               7d26s21
                   xk=xk*phase2                                         7d26s21
                   orig=sum
                   sum=sum+xj*2d0
     $                   -xk
                  else                                                   6d22s21
                   ...
                   xj=0d0                                               7d26s21
                   do ii2e=1,n2e                                        7d26s21
                    if(multh(isa,isb).eq.isymop(i2eop(1,ii2e)).and.     1d27s23
     $                   isymop(i2eop(2,ii2e)).eq.1)then                7d26s21
                     iab=ixmt(isa,i2eop(1,ii2e))                        7d26s21
     $                  +iga+idoubo(isa)+nbasdws(isa)*(igb+idoubo(issb))7d26s21
                     icd=ixmt(js,i2eop(2,ii2e))                         7d26s21
     $                  +(jg+idoubo(js))*(nbasdws(js)+1)                7d26s21
     ...
     $               bc(jgg),jsbv12,nsymb,multh,nvirt,nrootu,sr2,       6d24s21
     $                bc(iygoal),jgg,'d',1,bc,ibc)                      11d10s22
                 ibcoff=iprod                                            6d22s21
                 do i=1,nok                                                    11d13s20
...
c
     ...
     $                    nrootu,sr2,bc(iygoal),jgg,'e',1,bc,ibc)       11d10s22
                     ibcoff=iprod                                        6d22s21
                    end if                                                  12d14s20
                   end if                                                 4d14s21
                  end if                                                   12d14s20
                 end do                                                    12d14s20
                else if(nnot.ge.3.and.n2e.gt.0)then                     8d24s21
     ...
     $               iwpk2,ncsfmid2,bc,ibc)                             11d14s22
                   if(nnot1.eq.2.and.nnot2.eq.2)then                    6d22s21
                    lsa=ism(nab1(1))                                       12d14s20
                    lga=irel(nab1(1))-1+idoubo(lsa)                     7d26s21
                    lsb=ism(nab1(2))                                       12d14s20
                    lgb=irel(nab1(2))-1+idoubo(lsb)                     7d26s21
                    lsc=ism(nab2(1))                                     1d8s21
                    lgc=irel(nab2(1))-1+idoubo(lsc)                     7d26s21
                    lsd=ism(nab2(2))                                     1d8s21
                    lgd=irel(nab2(2))-1+idoubo(lsd)                     7d26s21
                    xint=0d0                                            7d26s21
                    do ii2e=1,n2e                                       7d26s21
                     if(multh(lsa,lsb).eq.isymop(i2eop(1,ii2e)))then    7d26s21
                      iab=ixmt(lsa,i2eop(1,ii2e))                       7d26s21
     $                   +lga+nbasdws(lsa)*lgb                          7d26s21
                      icd=ixmt(lsc,i2eop(2,ii2e))                       7d26s21
     $                   +lgc+nbasdws(lsc)*lgd                          7d26s21
                      xint=xint+bc(iab)*bc(icd)                         7d26s21
                     end if                                             7d26s21
                    end do                                              7d26s21
                    xint=xint*phase2                                    7d26s21
     ...
     $                iprod,bc,ibc)                                     11d10s22
                    ...
                    call hcdduc1(bc(iprod),ncsf,ncsf2,iarg,jarg,        6d22s21
     $                    bc(jvd),bc(jgg),jsbv12,nsymb,multh,nvirt,     6d24s21
     $                    nrootu,sr2,bc(iygoal),jgg,'f',1,bc,ibc)       11d10s22
                    ibcoff=iprod                                        6d22s21
...
c     re-order it to nvv,nroot,ncsf,iff2                                6d21s21
     ...
     $                    nrootu,sr2,bc(iygoal),0,'h',1,bc,ibc)         11d10s22
     ...
     $                  bc(iygoal),0,'hk1',1,bc,ibc)                    11d10s22
                   call hcdduc2(bc(itmpk2),ncsf,ncsf2,iarg,jarg,bc(jvd),7d2s21
     $                  bc(kden2),jsbv12,nsymb,multh,nvirt,nrootu,sr2,  7d2s21
     $                  bc(iygoal),0,'hk2',1,bc,ibc)                    11d10s22
                  else                                                  6d22s21
                   call hcdduc1(bc(iprod),ncsf,ncsf2,iarg,jarg,         6d22s21
     $                    bc(jvd),bc(jden),jsbv12,nsymb,multh,nvirt,    6d24s21
     $                    nrootu,sr2,bc(iygoal),0,'j',1,bc,ibc)         11d10s22
                  end if                                                6d22s21
                 end do                                                 6d22s21
                 ibcoff=iprod                                           6d22s21
                 do i=1,nok                                              1d8s21
...
c
     ...
     $                    nrootu,sr2,bc(iygoal),0,'k1',1,bc,ibc)        11d10s22
                     do jjj=ncsf2(jarg),ncsf(jarg)-1                    7d23s21
     ...
     $                    bc(jvd),bc(kden),jsbv12,nsymb,multh,nvirt,    6d24s21
     $                    nrootu,sr2,bc(iygoal),0,'k2',1,bc,ibc)        11d10s22
                     ibcoff=iprod                                       7d1s21
                    end if                                               6d22s21
                   end if
                  end if                                                6d22s21
                 end do                                                 6d22s21
                else if(nnot.gt.3.and.n2e.gt.0)then                     8d24s21
                 if(nnot.eq.3)then                                          12d8s20
                  ipssx=1                                                   12d8s20
                 else                                                       12d8s20
                  ipssx=3                                                 12d18s20
     ...
     $                iprod,bc,ibc)                                     11d10s22
                 ...
                 sz=sqrt(sz/dfloat(nrow))
                     call hcdduc2(bc(iprod),ncsf,ncsf2,iarg,jarg,       7d2s21
     $                    bc(jvd),bc(kden),jsbv12,nsymb,multh,nvirt,    6d24s21
     $                    nrootu,sr2,bc(iygoal),0,'l',1,bc,ibc)         11d10s22
                     do jjj=ncsf2(jarg),ncsf(jarg)-1                    7d23s21
                      jprod=iprod+ncsf(iarg)*jjj                        7d1s21
                      do iii=0,ncsf(iarg)-1                             7d1s21
                       bc(jprod+iii)=-bc(jprod+iii)                     7d1s21
                     ...
                     call hcdduc2(bc(iprod),ncsf,ncsf2,iarg,jarg,       7d2s21
     $                    bc(jvd),bc(kden),jsbv12,nsymb,multh,nvirt,    6d24s21
     $                    nrootu,sr2,bc(iygoal),0,'l2',1,bc,ibc)        11d10s22
                    else                                                  1d8s21
                     ia=nab1(1)                                         7d26s21
                     ib=nab1(2)                                         7d26s21
                     lsa=ism(ia)                                           1d8s21
                     ...
                     lga=irel(ia)-1                                        1d8s21
                     lgb=irel(ib)-1                                        1d8s21
                      icol=lga+irefo(lsa)*lgb                           7d26s21
                     bc(ndenj(lsa)+icol)=1d0                            6d23s21
                     jden=idenj(lsa)+nmrow*icol                         6d30s21
                     call hcdduc1(bc(iprod),ncsf,ncsf2,iarg,jarg,         6d22s21
     $                    bc(jvd),bc(jden),jsbv12,nsymb,multh,nvirt,    6d24s21
     $                    nrootu,sr2,bc(iygoal),0,'m',1,bc,ibc)         11d10s22
                    end if                                                1d8s21
                    ibcoff=iprod                                        6d22s21
    ...
    4            continue                                               6d22s21
              ...
              if(isb.eq.jsb.and.ncloi.eq.ncloj.and.if2.eq.jf2.          7d23s21
     $             and.(n2e.gt.0.or.isymop(lxmt).eq.1))then             7d27s21
               sum=0d0                                                  7d27s21
               if(isymop(lxmt).eq.1)then                                7d27s21
                do i=1,norb                                             7d27s21
                 if(btest(i2c,i).or.btest(i2o,i))then                   7d27s21
                  ff=phase1                                             7d27s21
                  if(btest(i2c,i))ff=ff*2d0                             7d27s21
                  js=ism(i)                                             7d27s21
                  jg=irel(i)-1+idoubo(js)                               7d27s21
                  iad=ixmtf(js)+jg*(nbasdws(js)+1)                      7d27s21
                  orig=sum
                  sum=sum+ff*bc(iad)                                    7d27s21
                 end if                                                 7d27s21
                end do                                                  7d27s21
               end if                                                   7d27s21
               do i=1,norb                                              7d14s21
                ...
                if(btest(i2c,i).and.n2e.gt.0)then                       12d13s22
                 do j=1,norb                                            7d14s21
                  js=ism(j)                                             7d14s21
                  jg=irel(j)-1+idoubo(js)                               7d14s21
                  if(btest(i2c,j))then                                  7d14s21
                  ...
                  else if(btest(i2o,j))then                             12d13s22
                   do ii2e=1,n2e                                        7d14s21
                    if(isymop(i2eop(1,ii2e)).eq.1)then                  7d14s21
                     iii=ixmt(is,i2eop(1,ii2e))+ig*(nbasdws(is)+1)      7d14s21
                     jjj=ixmt(js,i2eop(2,ii2e))+jg*(nbasdws(js)+1)      7d14s21
                ...
                if(btest(i2o,i).and.n2e.gt.0)then                       12d13s22
                 do j=1,norb                                            7d14s21
                  if(j.ne.i.and.btest(i2o,j))then                       7d14s21
                   js=ism(j)                                            7d14s21
                   jg=irel(j)-1+idoubo(js)                              7d14s21
               ...
               call enough('hcdducbk. 10',bc,ibc)
               i18=1                                                    7d1s21
               i28=nrow                                                 7d1s21
               i38=if2                                                  7d1s21
               call ddi_get(bc,ibc,ihddiagk(ncloip,isb,1),i18,i28,i38,  11d15s22
                  ...
                  do ksbv1=1,nsymb                                       7d2s21
                   ...
                   if(ksbv2.ge.ksbv1)then                                7d2s21
                    if(jsbv12.eq.1)then                                  7d2s21
                     ...
                     ktmpp=ktmp+nrootu*nvirt(ksbv1)*ncsf2(iarg)          7d23s21
                     do jv=0,nvirt(jsbv1)-1                                7d1s21
                      jvpp=jv+idoubo(jsbv1)+irefo(jsbv1)                 7d23s21
                      jjvdl=jjvd+nn*jv                                   7d3s21
                      do kv2=0,nvirt(ksbv2)-1                             7d2s21
                       kv2pp=kv2+idoubo(ksbv2)+irefo(ksbv2)              7d23s21
                       ktmpl=ktmp+nn*kv2                                 7d3s21
                       ntop=(kv2+isw*(nvirt(ksbv1)-kv2))-1               7d3s21
                       if(mod(idoit,mynprocg).eq.mynowprog)then          7d23s21
                        xinta=0d0                                        7d23s21
                        do ii2e=1,n2e                                    7d23s21
                         if(multh(ksbv1,jsbv1).eq.isymop(i2eop(1,ii2e))  7d23s21
     $             .and.multh(ksbv2,jsbv2).eq.isymop(i2eop(2,ii2e)))then7d23s21
                          ik1j1=ixmt(ksbv1,i2eop(1,ii2e))+kv2pp+         7d26s21
     $                       nbasdws(ksbv1)*jvpp                        7d23s21
                          ik2j2=ixmt(ksbv2,i2eop(2,ii2e))+kv2pp+         7d23s21
     $                        nbasdws(ksbv2)*jvpp                       7d23s21
                          xinta=xinta+bc(ik1j1)*bc(ik2j2)                7d26s21
                         end if                                          7d23s21
                        end do                                           7d23s21
                        xinta=xinta*phase2                               7d23s21
                       ...
                       idoit=idoit+1                                     7d23s21
                       do kv1=0,ntop                                     7d2s21
                        if(mod(idoit,mynprocg).eq.mynowprog)then         7d23s21
                         kv1pp=kv1+idoubo(ksbv1)+irefo(ksbv1)            7d23s21
                         xinta=0d0                                       7d23s21
                         do ii2e=1,n2e                                   7d23s21
                          if(multh(ksbv1,jsbv1).eq.isymop(i2eop(1,ii2e)) 7d23s21
     $             .and.multh(ksbv2,jsbv2).eq.isymop(i2eop(2,ii2e)))then7d23s21
                           ik1j1=ixmt(ksbv1,i2eop(1,ii2e))+kv1pp         7d23s21
     $                        +nbasdws(ksbv1)*jvpp                      7d23s21
                           ik2j2=ixmt(ksbv2,i2eop(2,ii2e))+kv2pp         7d23s21
     $                        +nbasdws(ksbv2)*jvpp                      7d23s21
                           xinta=xinta+bc(ik1j1)*bc(ik2j2)               7d23s21
                          end if                                         7d23s21
                         end do                                          7d23s21
                         xinta=xinta*phase2*sr2                          7d23s21
                         if(xinta.ne.0d0)then                             7d6s21
                     ...
                     do kv=0,nvirt(ksbv1)-1                              7d3s21
                      kvpp=kv+idoubo(ksbv1)+irefo(ksbv1)                 7d23s21
                      ktmpl=ktmp+nn*kv                                   7d3s21
                      do jv2=0,nvirt(jsbv2)-1                            7d3s21
                       jv2pp=jv2+idoubo(jsbv2)+irefo(jsbv2)              7d23s21
                       ntop=(jv2+isw*(nvirt(jsbv1)-jv2))-1               7d3s21
                       do jv1=0,ntop                                     7d6s21
                        if(mod(idoit,mynprocg).eq.mynowprog)then         7d23s21
                         xinta=0d0                                       7d23s21
                         jv1pp=jv1+irefo(jsbv1)+idoubo(jsbv1)            7d23s21
                         do ii2e=1,n2e                                   7d23s21
                          if(multh(ksbv1,jsbv1).eq.isymop(i2eop(1,ii2e))  7d23s21
     $            .and.multh(ksbv2,jsbv2).eq.isymop(i2eop(2,ii2e)))then 7d23s21
                           ik1j1=ixmt(ksbv1,i2eop(1,ii2e))+kvpp           7d23s21
     $                        +nbasdws(ksbv1)*jv1pp                     7d23s21
                           ik2j2=ixmt(ksbv2,i2eop(2,ii2e))+kvpp          7d23s21
     $                         +nbasdws(ksbv2)*jv2pp                    7d23s21
                           xinta=xinta+bc(ik1j1)*bc(ik2j2)               7d23s21
                          end if                                         7d23s21
                         end do                                          7d23s21
                         xinta=xinta*phase2*sr2                          7d23s21
                    ...
                    do kv2=0,nvirt(ksbv2)-1                              7d3s21
                     ...
                     do jv2=0,nvirt(jsbv2)-1                             7d3s21
                      jv2pp=jv2+irefo(jsbv2)+idoubo(jsbv2)               7d23s21
                      ...
                      do kv1=0,ktop                                      7d6s21
                       ...
                       do jv1=0,jtop                                     7d6s21
                        if(mod(idoit,mynprocg).eq.mynowprog)then         7d23s21
                         jv1pp=jv1+idoubo(jsbv1)+irefo(jsbv1)            7d23s21
                         xinta=0d0                                       7d23s21
                         do ii2e=1,n2e                                   7d23s21
                          if(multh(ksbv1,jsbv1).eq.isymop(i2eop(1,ii2e)) 7d23s21
     $           .and.multh(ksbv2,jsbv2).eq.isymop(i2eop(2,ii2e)))then  7d23s21
                      ...
                      do jv2=jbot,nvirt(jsbv2)-1                         7d6s21
                       ...
                       do kv1=0,ktop
                        if(mod(idoit,mynprocg).eq.mynowprog)then         7d23s21
                         ...
                         xinta=0d0                                       7d23s21
                         do ii2e=1,n2e                                   7d23s21
                          if(multh(ksbv1,jsbv2).eq.isymop(i2eop(1,ii2e)) 7d23s21
     $             .and.multh(ksbv2,jsbv1).eq.isymop(i2eop(2,ii2e)))then7d23s21
                           ik1j2=ixmt(ksbv1,i2eop(1,ii2e))+kv1pp         7d23s21
     $                        +nbasdws(ksbv1)*jv2pp                     7d23s21
                           ik2j1=ixmt(ksbv2,i2eop(2,ii2e))+kv2pp         7d23s21
     $                         +nbasdws(ksbv2)*jv1pp                    7d23s21
                           xinta=xinta+bc(ik1j2)*bc(ik2j1)               7d26s21
                          end if                                         7d23s21
                         end do                                          7d23s21
                         xinta=xinta*phase2                             7d27s21
                         if(xinta.ne.0d0)then                             7d6s21
                ...
                if(jsbv2.ge.jsbv1)then                                  7d3s21
                 if(jsbv1.eq.jsbv2)then                                 7d3s21
                  ...
                  do iv=0,nvirt(jsbv1)-1                                7d3s21
                   if(mod(iv,mynprocg).eq.mynowprog)then                1d30s23
                    sump=sum                                             7d27s21
                    if(isymop(lxmt).eq.1)then                            7d27s21
                     ivp=iv+idoubo(jsbv1)+irefo(jsbv1)                   7d27s21
                     iad=ixmtf(jsbv1)+ivp*(nbasdws(jsbv1)+1)             7d27s21
                     sump=sump+2d0*bc(iad)*phase1                        7d27s21
                    end if                                               7d27s21
                   else                                                 1d30s23
                    sump=0d0                                            1d30s23
                   end if                                               1d30s23
                   do ii=0,nnm                                          7d3s21
                    ...
                    bc(ij)=bc(ij)+bc(ji)+sump*bc(jjtmp+ii)              7d27s21
                   end do                                               7d3s21
                   jjtmp=jjtmp+nn                                       7d27s21
                  end do                                                7d3s21
                  isw=0                                                 7d27s21
                 else                                                   7d3s21
                  jtmpp=jtmp                                            7d3s21
                 ...
                 nvvm=nvv-1                                             7d3s21
                 nvvq=0
                 do iv2=0,nvirt(jsbv2)-1                                7d27s21
                  ivtop=(iv2+isw*(nvirt(jsbv1)-iv2))-1                  7d27s21
                  do iv1=0,ivtop                                        7d27s21
                   nvvq=nvvq+1
                   itri=((iv2*(iv2-1))/2)+iv1                           7d27s21
                   irec=iv1+nvirt(jsbv1)*iv2                            7d27s21
                   ivv=itri+isw*(irec-itri)                             7d27s21
                   if(mod(nvvq-1,mynprocg).eq.mynowprog)then            1d30s23
                    sump=sum                                             7d27s21
                    if(isymop(lxmt).eq.1)then                            7d27s21
                     iv2p=iv2+idoubo(jsbv2)+irefo(jsbv2)                 7d27s21
                     iad2=ixmtf(jsbv2)+iv2p*(nbasdws(jsbv2)+1)           7d27s21
                     iv1p=iv1+idoubo(jsbv1)+irefo(jsbv1)                 7d27s21
                     iad1=ixmtf(jsbv1)+iv1p*(nbasdws(jsbv1)+1)           7d27s21
                     sump=sump+phase1*(bc(iad1)+bc(iad2))                7d27s21
                    end if                                               7d27s21
                   else                                                 1d30s23
                    sump=0d0                                            1d30s23
                   end if                                               1d30s23
                   ...
                   jjtmp=jjtmp+nna                                       7d27s21
                  end do                                                7d27s21
                 end do                                                 7d3s21
                 if(nvvq.ne.nvv)then
                  write(6,*)('have nvvq nvv mismatch!! '),nvvq,nvv,
     $                 jsbv1,jsbv2
                  call dws_synca
                  call dws_finalize
                  stop
               ...
               do jsbv1=1,nsymb                                         7d1s21
                ...
                if(jsbv2.ge.jsbv1)then                                  7d1s21
                 if(jsbv1.eq.jsbv2)then                                 7d1s21
                  ...
                  nhere=nvirt(jsbv1)*ncsf2(iarg)*nrootu                 7d23s21
...
c     !jf2
             ...
             if(ibc(mdenh).ne.0)then                                    6d23s21
              ...
              ibcoff=mdenhc+nrow                                        8d20s21
              call enough('hcdducbk. 11',bc,ibc)
              do kkk=0,nrow-1                                           8d20s21
              ...
              if(ncol.gt.0)then
               ...
               do kkk=0,ncol-1                                          6d22s21
                ...
                if(ibc(ndenk(isa)+kkk).ne.0)then                        6d23s21
                 ...
                 call enough('hcdducbk. 12',bc,ibc)
                 ...
                 ibcoff=ibcoff+nmrowk                                   7d2s21
                 call enough('hcdducbk. 13',bc,ibc)
                 do i=0,nmrowk-1                                        7d2s21
                  bc(jdenkc+i)=bc(iad+i)                                6d23s21
                 end do                                                 6d23s21
                 jdenkc=jdenkc+nmrowk                                   7d2s21
               ...
               if(ncolu.gt.0)then
                ...
                do kkk=0,ncolu-1                                         6d22s21
                 ...
                 if(ibc(ndenj(isa)+kkk).ne.0)then                       6d23s21
                  ...
                  call enough('hcdducbk. 14',bc,ibc)
             ...
             call second(timex)
              ...
              if(itransgg.eq.0)then                                      2d12s21
               call ddi_done(ibc(iacc),nacc)                             2d12s21
               itransgg=1                                                2d12s21
               do i=igg,igg+mrow*nff2b(ncloip,isb,1)-1                    6d22s21
                bc(i)=0d0                                                2d12s21
               end do                                                    2d12s21
              end if                                                     2d12s21
              ...
              do isbv1=1,nsymb                                                1d12s21
               ...
               if(isbv2.ge.isbv1)then                                         1d12s21
                if(isbv12.eq.1)then                                           1d12s21
                 ...
                 ioffp=ioff+nvirt(isbv1)*nrootu*ncsf2(iarg)             7d23s21
                else                                                          1d12s21
                 isw=1                                                        1d12s21
                ...
                do jsbv1=1,nsymb                                              1d12s21
                 ...
                 if(jsbv2.ge.jsbv1)then                                       1d12s21
                  if(jsbv12.eq.1)then                                         1d12s21
                   ...
                   joffp=joff+nvirt(jsbv1)*nrootu*ncsf2(iarg)           7d23s21
...
c                   Gvv rj=djiab (ab|vv ) Vvv ri match = 1 to 4.
     ...
     $                       mynowprog,il,ih,i1s,i1e,i2s,i2e)                  1d12s21
                     ...
                     if(min(nhere,nvirt(isbvc),n2e).gt.0)then           7d23s21
                      nr=nvirt(isbvc)*nrootu*ncsf(iarg)                 6d23s21
                      itmpp=ibcoff                                      6d23s21
                      ibcoff=itmpp+nr*nvirt(isbl)                       6d30s21
                      call enough('hcdducbk. 15',bc,ibc)
                      fact=0d0                                          6d23s21
                      do lsb=1,nsymb                                    6d23s21
                       lsc=multh(lsb,ijsb)                              6d29s21
                       if(mdenj(lsb).ne.0)then                          7d26s21
                        nm=nhere2*mdenj(lsb)                            6d30s21
                        itmpi=ibcoff                                    6d23s21
                        ivtmp=itmpi+nvirt(isbl)*nm                      6d30s21
                        ibcoff=ivtmp+nr*nm                              6d30s21
                        call enough('hcdducbk. 16',bc,ibc)
                        do kkk=itmpi,ibcoff-1                           6d23s21
                         bc(kkk)=0d0                                    6d23s21
                        end do                                          6d23s21
                        do j=0,mdenj(lsb)-1                             6d23s21
                         jj=ibc(ndenj(lsb)+j)                           6d23s21
                         jc=jj/irefo(lsb)                               6d23s21
                         jb=jj-irefo(lsb)*jc                            6d23s21
                         jc=jc+idoubo(lsc)                              7d26s21
                         jb=jb+idoubo(lsb)                              7d26s21
                         jint=ibcoff                                    7d23s21
                         ibcoff=jint+nhere                              7d23s21
                         call enough('hcdducbk. 17',bc,ibc)
                         nhit=0
                         do iz=jint,ibcoff-1                            7d23s21
                          bc(iz)=0d0                                    7d23s21
                         end do                                         7d23s21
                         do ii2e=1,n2e                                  7d23s21
                          if(multh(lsc,lsb).eq.                         7d23s21
     $                         isymop(i2eop(1,ii2e)).and.               7d26s21
     $                    multh(isbl,isbr).eq.isymop(i2eop(2,ii2e)))then7d26s21
                           nhit=nhit+1
                           i10=i1s                                      7d23s21
                           i1n=nvirt(isbl)                              7d23s21
                           jjint=jint                                   7d23s21
                           ibcx=ixmt(lsb,i2eop(1,ii2e))+jb               7d26s21
     $                          +nbasdws(lsb)*jc                        7d26s21
                           fbc=phase2*bc(ibcx)                          7d26s21
                           do i2=i2s,i2e                                7d23s21
                            i2pp=i2-1+idoubo(isbr)+irefo(isbr)          7d23s21
                            ivv=ixmt(isbl,i2eop(2,ii2e))+idoubo(isbl)-1 7d26s21
     $                           +irefo(isbl)+nbasdws(isbl)*i2pp        7d23s21
                            if(i2.eq.i2e)i1n=i1e                        7d23s21
                            do i1=i10,i1n                               7d23s21
                             orig=bc(jjint)
                             bc(jjint)=bc(jjint)+fbc*bc(ivv+i1)         7d26s21
                             jjint=jjint+1                              7d23s21
                            end do                                      7d23s21
                            i10=1                                       7d23s21
                           end do                                       7d23s21
                          end if                                        7d23s21
     ...
     $                             (ir+nrootu*(i+ncsf(iarg)*iv2)))      6d30s21
                          ...
                          tfr=1d0                                       6d30s21
                          do i=0,ncsf(iarg)-1                           6d23s21
                           if(i.eq.ncsf2(iarg))tfr=-1d0                 7d23s21
                           do ir=0,nrootm                               6d23s21
     ...
     d' hcdducbk.  1')
                       ...
                       if(mdenk(lsb).ne.0)then                          7d1s21
                        ...
                        ivtmp=itmpi+nvirt(isbl)*nm                      6d30s21
                        ibcoff=ivtmp+nr*nm                              6d30s21
                        call enough('hcdducbk. 18',bc,ibc)
                        do kkk=itmpi,ibcoff-1                           6d23s21
                         bc(kkk)=0d0                                    6d23s21
                        end do                                          6d23s21
                        do j=0,mdenk(lsb)-1                             6d23s21
                         ...
                         jc=jj/irefo(lsb)                               6d23s21
                         jb=jj-irefo(lsb)*jc                            6d23s21
                         jc=jc+idoubo(lsc)                              7d23s21
                         jb=jb+idoubo(lsb)                              7d23s21
                         kint=ibcoff                                    7d23s21
                         ibcoff=kint+nhere                              7d23s21
                         call enough('hcdducbk. 19',bc,ibc)
                         do iz=kint,ibcoff-1                            7d23s21
                          bc(iz)=0d0                                    7d23s21
                         end do                                         7d23s21
                         do ii2e=1,n2e                                  7d23s21
                          if(multh(lsb,isbr).eq.                        7d23s21
     $                         isymop(i2eop(1,ii2e)))then               7d23s21
                           i10=i1s                                      7d23s21
                           i1n=nvirt(isbl)                              7d23s21
                           jjint=kint                                   7d23s21
                           do i2=i2s,i2e                                7d23s21
                            i2pp=i2-1+idoubo(isbr)+irefo(isbr)          7d23s21
                            ibv=ixmt(lsb,i2eop(1,ii2e))+jb              7d27s21
     $                           +nbasdws(lsb)*i2pp                     7d23s21
                            fbv=phase2*bc(ibv)                          7d23s21
                            ivc=ixmt(isbl,i2eop(2,ii2e))+idoubo(isbl)-1 7d27s21
     $                           +irefo(isbl)+nbasdws(isbl)*jc          7d23s21
                            if(i2.eq.i2e)i1n=i1e                        7d23s21
                            do i1=i10,i1n                               7d23s21
                             orig=bc(jjint)
                             bc(jjint)=bc(jjint)+fbv*bc(ivc+i1)         7d26s21
                             jjint=jjint+1                              7d23s21
                            end do                                      7d23s21
                            i10=1                                       7d23s21
                           end do                                       7d23s21
                         ...
                         do i2=i2s,i2e                                   6d23s21
                          ...
                          do i1=i10,i1n                                 6d23s21
                           iv1=i1-1                                      6d23s21
                           iad=itmpi+iv1+nvirt(isbl)*(i2-i2s+nhere2*j)  6d30s21
                           bc(iad)=bc(kkint)                            7d26s21
                           kkint=kkint+1                                7d26s21
                          end do                                         6d23s21
                          i10=1                                          6d23s21
                         end do                                          6d23s21
                         if(ibr.eq.1)then                               6d23s21
     ...
     $                             (ir+nrootu*(i+ncsf(iarg)*iv2)))      6d30s21
                         ...
                         nzro=0
                          tf=1d0                                        7d2s21
                          do i=0,ncsf(iarg)-1                           6d23s21
                           if(i.eq.ncsf2(iarg))tf=-1d0                  7d23s21
                           do ir=0,nrootm                               6d23s21
                            do iv2p=i2s,i2e                             6d30s21
                             iv2=iv2p-1                                 6d30s21
                             ntop=iv2+jsw*(nvirt(isbvc)-iv2)            6d30s21
     ...
     $                          (i+ncsf(iarg)*iv2))                     6d30s21
                        ...
                        do iv1=0,nvirt(isbv1)-1                         6d30s21
                         ...
                         tfl=1d0                                        6d30s21
                         do i=0,ncsf(iarg)-1                             6d23s21
                          if(i.eq.ncsf2(iarg))tfl=-1d0                  7d23s21
                          do ir=0,nrootm                                 6d23s21
     ...
     $                          (i+ncsf(iarg)*iv2))                     6d30s21
              ...
              if(ijsb.eq.1.and.mdenhc.gt.0)then                         6d26s21
               if(iarg.ne.jarg)then                                     8d20s21
                write(6,*)('in ijsb block, iarg = '),iarg,
     $              (' is ne jarg ='),jarg
                call dws_synca
                call dws_finalize
                stop 'hcdducbk'
               ...
               joff=0                                                   8d20s21
               do jsbv1=1,nsymb                                         8d20s21
                jsbv2=multh(jsbv1,jsbv12)                               8d20s21
                if(jsbv2.ge.jsbv1)then                                  8d20s21
                 if(jsbv1.eq.jsbv2)then                                 8d20s21
                  joffp=joff+nvirt(jsbv1)*nrootu*ncsf2(iarg)            8d20s21
                  jsw=0                                                 8d20s21
                  mvv=(nvirt(jsbv1)*(nvirt(jsbv1)-1))/2                 8d20s21
                 else                                                   8d20s21
                  jsw=1                                                 8d20s21
                  joffp=joff                                            8d20s21
                  mvv=nvirt(jsbv1)*nvirt(jsbv2)                         8d20s21
                 end if                                                 8d20s21
                 ioff=0                                                   6d24s21
                 jgg=igg+mrow*(if2-1)                                   8d20s21
...
c     nvv,nroot,ncsf,iff2                                               6d24s21
                    ...
                    isw=0                                                 6d24s21
                    if(jsbv1.eq.isbv1)then                              8d20s21
                     if(multh(jsbv2,isbv1).eq.isymop(lxmt))then         8d20s21
                      do i=0,ncsf2(iarg)-1                                  7d23s21
                       do ir=0,nrootm                                       6d28s21
                        lgg=jgg+ioff+nvirt(isbv1)*(ir+nrootu*i)             6d29s21
                        kad1=mdenhc+joffp+mvv*(ir+nrootu*i)             8d20s21
                        do iv1=0,nvirt(isbv1)-1                             6d28s21
                         if(mod(idoit,mynprocg).eq.mynowprog)then           6d28s21
                          iv1pp=iv1+idoubo(isbv1)+irefo(isbv1)              7d23s21
                          ih0=ixmtf(isbv1)+iv1pp                        8d20s21
     $                     +nbasdws(isbv1)*(idoubo(jsbv2)+irefo(jsbv2)) 8d20s21
                          ibot=(iv1+1)*(1-jsw)                          8d20s21
                          do jv2=ibot,nvirt(jsbv2)-1                    8d20s21
                           irec=iv1+nvirt(jsbv1)*jv2                    8d20s21
                           itri=((jv2*(jv2-1))/2)+iv1                   8d20s21
                           irow=itri+jsw*(irec-itri)                    8d20s21
                           bc(lgg+iv1)=bc(lgg+iv1)
     $                        +bc(ih0+jv2*nbasdws(isbv1))*bc(kad1+irow) 6d29s21
     $                      *sr2*phase1                                 7d23s21
                          end do                                        8d20s21
                         end if                                         8d20s21
                         idoit=idoit+1                                  8d20s21
                        end do                                          8d20s21
                       end do                                           8d20s21
                      end do                                            8d20s21
                     end if                                             8d20s21
...
c     Gvv Hvv" Vv"v
                    if(isbv1.eq.jsbv2.and.
     $                   multh(isbv1,jsbv1).eq.isymop(lxmt))then
                     ff=phase1*sr2                                      8d21s21
                     do i=0,ncsf2(iarg)-1                               8d21s21
                      do ir=0,nrootm                                    8d21s21
                       lgg=jgg+ioff+nvirt(isbv1)*(ir+nrootu*i)             6d29s21
                       iad1=mdenhc+joffp+mvv*(ir+nrootu*i)              8d20s21
                       do iv=0,nvirt(jsbv2)-1                           8d21s21
                        if(mod(idoit,mynprocg).eq.mynowprog)then        8d21s21
                         jtop=(iv+jsw*(nvirt(jsbv1)-iv))-1              8d21s21
                         ih0=ixmtf(isbv1)+iv+idoubo(isbv1)+irefo(isbv1) 8d21s21
     $                      +nbasdws(isbv1)*(idoubo(jsbv1)+irefo(jsbv1))8d21s21
                         jrec=nvirt(jsbv1)*iv                           8d21s21
                         jtri=((iv*(iv-1))/2)                           8d21s21
                         kad1=iad1+jtri+jsw*(jrec-jtri)                 8d21s21
                         kgg=lgg+iv                                     8d21s21
                         do ivpp=0,jtop                                 8d21s21
                          bc(kgg)=bc(kgg)+bc(ih0+ivpp*nbasdws(isbv1))   8d21s21
     $                         *bc(kad1+ivpp)*ff                        8d21s21
                         end do                                         8d21s21
                        end if                                          8d21s21
                        idoit=idoit+1                                   8d21s21
                       end do                                           8d21s21
                      end do                                            8d21s21
                     end do                                             8d21s21
                    end if
...
c     Gvv' Hv'v" Vvv"
                    if(isbv1.eq.jsbv1)then                              8d20s21
                     if(multh(jsbv2,isbv2).eq.isymop(lxmt))then         8d20s21
                      do i=0,ncsf2(iarg)-1                                  7d23s21
                       do ir=0,nrootm                                       6d28s21
                        iad1=mdenhc+joff+nvirt(jsbv1)*(ir+nrootu*i)         6d28s21
                        kgg=jgg+ioffp+nvv*(ir+nrootu*i)                 8d20s21
c     Gvv' Hv'v Vvv
                        do jiv=0,nvirt(isbv1)-1                             6d28s21
                         if(mod(idoit,mynprocg).eq.mynowprog)then           6d28s21
                          jivpp=jiv+idoubo(isbv1)+irefo(isbv1)              7d23s21
                          ih0=ixmtf(isbv2)+idoubo(isbv2)+irefo(isbv2)      7d23s21
     $                     +nbasdws(isbv2)*jivpp                        7d23s21
                          ibot=(jiv+1)*(1-isw)                          8d20s21
                          do iv2=ibot,nvirt(isbv2)-1                    8d20s21
                           irec=jiv+nvirt(isbv1)*iv2                    8d20s21
                           itri=((iv2*(iv2-1))/2)+jiv                   8d20s21
                           irow=itri+isw*(irec-itri)                    8d20s21
                           bc(kgg+irow)=bc(kgg+irow)+bc(ih0+iv2)*phase1 8d20s21
     $                          *bc(iad1+jiv)*sr2                       8d20s21
                          end do                                        8d20s21
                         end if                                         8d20s21
                         idoit=idoit+1                                  8d20s21
                        end do                                          8d20s21
...
c     Gvv' Hvv" Vv'v"
                    if(isbv2.eq.jsbv1)then                              8d20s21
                     if(multh(jsbv2,isbv1).eq.isymop(lxmt))then         8d20s21
                      do i=0,ncsf2(iarg)-1                                  7d23s21
                       do ir=0,nrootm                                       6d28s21
                        iad1=mdenhc+joff+nvirt(jsbv1)*(ir+nrootu*i)         6d28s21
                        kgg=jgg+ioffp+nvv*(ir+nrootu*i)                 8d20s21
                        do jiv=0,nvirt(isbv2)-1                             6d28s21
                         if(mod(idoit,mynprocg).eq.mynowprog)then           6d28s21
                          jivpp=jiv+idoubo(isbv2)+irefo(isbv2)              7d23s21
                          ih0=ixmtf(isbv1)+idoubo(isbv1)+irefo(isbv1)      7d23s21
     $                     +nbasdws(isbv1)*jivpp                        7d23s21
                          itop=(jiv+isw*(nvirt(isbv1)-jiv))-1           8d20s21
                          do iv1=0,itop                                 8d20s21
                           irec=iv1+nvirt(isbv1)*jiv                    8d20s21
                           itri=((jiv*(jiv-1))/2)+iv1                   8d20s21
                           irow=itri+isw*(irec-itri)                    8d20s21
                           bc(kgg+irow)=bc(kgg+irow)+bc(ih0+iv1)*phase1 8d20s21
     $                          *bc(iad1+jiv)*sr2                       8d20s21
                          end do                                        8d20s21
                         end if                                         8d20s21
                         idoit=idoit+1                                  8d20s21
...
c     Gvv'ri=dij Hvv" Vv'v"rj = Hvv"  Dv'v"ri
                   if(isbv2.eq.jsbv1.and.
     $                   multh(isbv1,jsbv2).eq.isymop(lxmt))then         8d20s21
                    tf=1d0                                                6d28s21
                    do i=0,ncsf(iarg)-1                                    6d28s21
                     if(i.eq.ncsf2(iarg))tf=-1d0                          7d23s21
                     do ir=0,nrootm                                        6d28s21
                      iad1=mdenhc+joffp+mvv*(ir+nrootu*i)                  6d28s21
                      lgg=jgg+ioffp+nvv*(ir+nrootu*i)                      6d28s21
                      do ivp=0,nvirt(isbv2)-1                             6d29s21
                       if(mod(idoit,mynprocg).eq.mynowprog)then           6d28s21
                        ivpp=ivp+1                                        6d28s21
                        itop=(ivp+isw*(nvirt(isbv1)-ivp))-1             8d20s21
                        ibot=ivpp*(1-jsw)                               8d20s21
                        do iv=0,itop                                    8d20s21
                         irec=iv+nvirt(isbv1)*ivp                       8d20s21
                         itri=((ivp*(ivp-1))/2)+iv                      8d20s21
                         irow=itri+isw*(irec-itri)
                         ivpp=iv+irefo(isbv1)+idoubo(isbv1)             8d21s21
                         ih0=ixmtf(isbv1)+ivpp
     $                      +nbasdws(isbv1)*(irefo(jsbv2)+idoubo(jsbv2))8d20s21
                         ff=tf*phase1                                   8d20s21
                         do ivpp=ibot,nvirt(jsbv2)-1                    8d20s21
                          jrec=ivp+nvirt(jsbv1)*ivpp                    8d20s21
                          jtri=((ivpp*(ivpp-1))/2)+ivp                  8d20s21
                          jrow=jtri+jsw*(jrec-jtri)                     8d20s21
                          bc(lgg+irow)=bc(lgg+irow)+ff
     $                          *bc(ih0+ivpp*nbasdws(isbv1))            8d20s21
     $                          *bc(iad1+jrow)                          8d20s21
                         end do                                         8d20s21
                        end do                                          8d20s21
                       end if                                           8d20s21
                       idoit=idoit+1                                    8d20s21
                   ...
                   if(jsbv2.eq.isbv1.and.
     $                   multh(isbv2,jsbv1).eq.isymop(lxmt))then        8d20s21
c     Gvv'ri=dij Hv'v" Vv"vrj = Hv'v" Dv"vri                            6d28s21
                    ...
                    do i=0,ncsf(iarg)-1                                    6d28s21
                     ...
                     do ir=0,nrootm                                        6d28s21
                      iad1=mdenhc+joffp+mvv*(ir+nrootu*i)                  6d28s21
                      lgg=jgg+ioffp+nvv*(ir+nrootu*i)                      6d28s21
                      do ivp=0,nvirt(isbv2)-1                           8d20s21
                       if(mod(idoit,mynprocg).eq.mynowprog)then         8d20s21
                        irec=nvirt(isbv1)*ivp                           8d20s21
                        itri=((ivp*(ivp-1))/2)                          8d20s21
                        irow=itri+isw*(irec-itri)                       8d20s21
                        kgg=lgg+irow                                    8d20s21
                        ih0=ixmtf(isbv2)+ivp+idoubo(isbv2)+irefo(isbv2) 8d20s21
     $                      +nbasdws(isbv2)*(idoubo(jsbv1)+irefo(jsbv1))8d20s21
                        itop=(ivp+isw*(nvirt(isbv1)-ivp))-1             8d20s21
                        ff=tf*phase1                                    8d20s21
                        do iv=0,itop                                    8d20s21
                         kkgg=kgg+iv
                         jrec=nvirt(jsbv1)*iv                           8d20s21
                         jtri=((iv*(iv-1))/2)                           8d20s21
                         jrow=jtri+jsw*(jrec-jtri)                      8d20s21
                         kad1=iad1+jrow                                 8d20s21
                         jtop=(iv+jsw*(nvirt(jsbv1)-iv))-1              8d20s21
                         do ivpp=0,jtop                                 8d20s21
                          bc(kkgg)=bc(kkgg)+ff*bc(kad1+ivpp)            8d20s21
     $                          *bc(ih0+ivpp*nbasdws(isbv2))             8d20s21
                         end do                                         8d20s21
                        end do                                          8d20s21
                       end if                                           8d20s21
                       idoit=idoit+1                                    8d20s21
                   ...
                   if(isbv2.eq.jsbv2.and.                               8d20s21
     $                  multh(isbv1,jsbv1).eq.isymop(lxmt))then         8d20s21
c     Gvv'ri=dij Hvv" Vv"v'rj = Hvv"  Dv"v'ri
c      xx              x x
c       x              x x
c                        x
                    do i=0,ncsf(iarg)-1                                    6d28s21
                     do ir=0,nrootm                                        6d28s21
                      iad1=mdenhc+joffp+mvv*(ir+nrootu*i)                  6d28s21
                      lgg=jgg+ioffp+nvv*(ir+nrootu*i)                      6d28s21
                      do ivp=0,nvirt(isbv2)-1                              6d28s21
                       itop=(ivp+isw*(nvirt(isbv1)-ivp))-1                 6d28s21
                       jtop=(ivp+jsw*(nvirt(jsbv1)-ivp))-1              8d20s21
                       if(mod(idoit,mynprocg).eq.mynowprog)then            6d28s21
                        irec=nvirt(isbv1)*ivp                           8d20s21
                        itri=((ivp*(ivp-1))/2)                          8d20s21
                        irow=itri+isw*(irec-itri)                       8d20s21
                        kgg=lgg+irow                                    8d20s21
                        jrec=nvirt(jsbv1)*ivp                           8d20s21
                        jrow=itri+jsw*(jrec-itri)                       8d20s21
                        kad1=iad1+jrow                                  8d20s21
                        do iv=0,itop                                      6d28s21
                         ih0=ixmtf(isbv1)+iv+idoubo(isbv1)+irefo(isbv1) 8d20s21
     ...
     $                         -bc(ih0+iv*nbasdws(isbv1))*bc(kad1+iv)   8d21s21
     $                      *phase1                                     7d23s21
                         end if                                         8d20s21
                        end do                                          8d20s21
                       end if                                           8d20s21
                   ...
                   if(isbv1.eq.jsbv1.and.                               8d20s21
     $                  multh(isbv2,jsbv2).eq.isymop(lxmt))then         8d20s21
...
c                        x
                    do i=0,ncsf(iarg)-1                                    6d28s21
                     do ir=0,nrootm                                        6d28s21
                      iad1=mdenhc+joffp+mvv*(ir+nrootu*i)                  6d28s21
                      lgg=jgg+ioffp+nvv*(ir+nrootu*i)                      6d28s21
                      do ivpp=0,nvirt(jsbv2)-1                           8d20s21
                       if(mod(idoit,mynprocg).eq.mynowprog)then         8d20s21
                        jtop=(ivpp+jsw*(nvirt(jsbv1)-ivpp))-1           8d20s21
                        ivppa=ivpp+idoubo(jsbv2)+irefo(jsbv2)           8d20s21
                        jrec=nvirt(jsbv1)*ivpp                          8d20s21
                        jtri=((ivpp*(ivpp-1))/2)                        8d20s21
                        kad1=iad1+jtri+jsw*(jrec-jtri)                  8d20s21
                        do ivp=0,nvirt(isbv2)-1                         8d20s21
                         itop=(ivp+isw*(nvirt(isbv1)-ivp))-1            8d20s21
                         ih0=ixmtf(isbv2)+ivp+idoubo(isbv2)+irefo(isbv2)8d20s21
     $                        +nbasdws(isbv2)*ivppa                     8d20s21
                         ff=bc(ih0)*phase1                              8d20s21
                         irec=nvirt(isbv1)*ivp                          8d20s21
                         itri=((ivp*(ivp-1))/2)                         8d20s21
                         kgg=lgg+itri+isw*(irec-itri)                   8d20s21
                         do iv=0,min(jtop,itop)                         8d20s21
                          bc(kgg+iv)=bc(kgg+iv)+ff*bc(kad1+iv)          8d20s21
                         end do                                         8d20s21
                        end do                                          8d20s21
                        if(jsbv2.eq.isbv2)then                          8d20s21
                         ih0=ixmtf(isbv2)+ivppa*(1+nbasdws(isbv2))      8d20s21
                         itop=(ivpp+isw*(nvirt(isbv1)-ivpp))-1          8d20s21
                         ff=bc(ih0)*phase1                              8d20s21
                         irec=nvirt(isbv1)*ivpp                         8d20s21
                         itri=((ivpp*(ivpp-1))/2)                         8d20s21
                         kgg=lgg+itri+isw*(irec-itri)                   8d20s21
                         do iv=0,min(itop,jtop)                         8d20s21
                          bc(kgg+iv)=bc(kgg+iv)-ff*bc(kad1+iv)          8d20s21
                         end do                                         8d20s21
                        end if                                          8d20s21
                       end if                                           8d20s21
...
c     !isbv1
                 ...
                 joff=joffp+mvv*nrootu*ncsf(iarg)                       8d20s21
                end if                                                  8d20s21
               end do                                                   8d20s21
c     !ijsb
              end if                                                    6d24s21
...
c
          ...
          call enough('hcdducbk. 20',bc,ibc)
          do if=0,nff2b(ncloip,isb,1)-1                                   6d22s21
              ...
              do i=0,ncsf2(iarg)-1                                      7d23s21
               do ir=0,nrootm
                do iv=0,nvirt(isbv1)-1                                  6d22s21
                 ktmp=jtmp+ir+nrootu*(i+ncsf2(iarg)*iv)                 7d23s21
                 bc(ktmp)=bc(jgg+iv)                                    6d22s21
                end do                                                  6d22s21
                jgg=jgg+nvirt(isbv1)                                    6d22s21
               end do                                                   6d22s21
              end do                                                    6d22s21
              jtmp=jtmp+nvirt(isbv1)*nrootu*ncsf2(iarg)                 7d23s21
          ...
          ibcoff=itmp                                                   6d22s21
          nacc=0
          call ddi_iacc(bc,ibc,ihddiagb(ncloip,isb),i18,i28,i38,i48,    11d15s22
     $         bc(igg),ibc(iacc),nacc)                                  11d15s22
          nwiacc=nwiacc+i28*(i48+1-i38)                                 1d27s23
          last8(1)=ihddiagb(ncloip,isb)                                 8d21s21
          last8(2)=i48                                                  2d17s21
          itransgg=0                                                     2d12s21
         else                                                           2d12s21
          nacc=0                                                        2d12s21
